 ...
 * void (*_g_reserved1)();
    ...
    public interface _g_reserved1 {
        ...
        static MemorySegment allocate(_g_reserved1 fi, Arena scope) {
            return RuntimeHelper.upcallStub(constants$1141.const$3, fi, constants$7.const$5, scope);
        }
 ...
 * void (*_g_reserved2)();
    ...
    public interface _g_reserved2 {
        ...
        static MemorySegment allocate(_g_reserved2 fi, Arena scope) {
            return RuntimeHelper.upcallStub(constants$1141.const$5, fi, constants$7.const$5, scope);
        }
    ...
    public static MemorySegment _g_reserved2$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)constants$1142.const$0.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment _g_reserved2$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)constants$1142.const$0.get(seg.asSlice(index*sizeof()));
    }
 ...
 * void (*_g_reserved3)();
    ...
    public interface _g_reserved3 {
        ...
        static MemorySegment allocate(_g_reserved3 fi, Arena scope) {
            return RuntimeHelper.upcallStub(constants$1142.const$1, fi, constants$7.const$5, scope);
        }
    ...
    public static MemorySegment _g_reserved3$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)constants$1142.const$2.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment _g_reserved3$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)constants$1142.const$2.get(seg.asSlice(index*sizeof()));
    }
 ...
 * void (*_g_reserved4)();
    ...
    public interface _g_reserved4 {
        ...
        static MemorySegment allocate(_g_reserved4 fi, Arena scope) {
            return RuntimeHelper.upcallStub(constants$1142.const$3, fi, constants$7.const$5, scope);
        }
    ...
    public static MemorySegment _g_reserved4$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)constants$1142.const$4.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void _g_reserved4$set(MemorySegment seg, MemorySegment x) {
        constants$1142.const$4.set(seg, x);
    }
    public static MemorySegment _g_reserved4$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)constants$1142.const$4.get(seg.asSlice(index*sizeof()));
    }
    public static void _g_reserved4$set(MemorySegment seg, long index, MemorySegment x) {
        constants$1142.const$4.set(seg.asSlice(index*sizeof()), x);
    }
 ...
 * void (*_g_reserved5)();
    ...
    public interface _g_reserved5 {
        ...
        static MemorySegment allocate(_g_reserved5 fi, Arena scope) {
            return RuntimeHelper.upcallStub(constants$1142.const$5, fi, constants$7.const$5, scope);
        }
    ...
    public static MemorySegment _g_reserved5$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)constants$1143.const$0.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment _g_reserved5$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)constants$1143.const$0.get(seg.asSlice(index*sizeof()));
    }
