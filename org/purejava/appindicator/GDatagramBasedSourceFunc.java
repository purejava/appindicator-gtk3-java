...
/**
 * {@snippet :
 * int (*GDatagramBasedSourceFunc)(struct _GDatagramBased* datagram_based,enum GIOCondition condition,void* data);
 * }
 */
public interface GDatagramBasedSourceFunc {
    ...
    static MemorySegment allocate(GDatagramBasedSourceFunc fi, Arena scope) {
        return RuntimeHelper.upcallStub(constants$695.const$0, fi, constants$150.const$0, scope);
    }
    static GDatagramBasedSourceFunc ofAddress(MemorySegment addr, Arena arena) {
