...
final class constants$1079 {
    ...
    static final MethodHandle const$1 = RuntimeHelper.upcallHandle(_GFileIOStreamClass.tell.class, "apply", constants$4.const$0);
    static final VarHandle const$2 = constants$1079.const$0.varHandle(MemoryLayout.PathElement.groupElement("tell"));
    static final MethodHandle const$3 = RuntimeHelper.upcallHandle(_GFileIOStreamClass.can_seek.class, "apply", constants$10.const$5);
    static final VarHandle const$4 = constants$1079.const$0.varHandle(MemoryLayout.PathElement.groupElement("can_seek"));
    static final MethodHandle const$5 = RuntimeHelper.upcallHandle(_GFileIOStreamClass.seek.class, "apply", constants$1066.const$1);
}
