...
/**
 * {@snippet :
 * void (*gtk_accel_map_foreach_unfiltered$foreach_func)(void*,char*,unsigned int,enum GdkModifierType,int);
 * }
 */
public interface gtk_accel_map_foreach_unfiltered$foreach_func {
