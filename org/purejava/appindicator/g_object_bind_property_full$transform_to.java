...
/**
 * {@snippet :
 * int (*g_object_bind_property_full$transform_to)(struct _GBinding*,struct _GValue*,struct _GValue*,void*);
 * }
 */
public interface g_object_bind_property_full$transform_to {
    ...
    static MemorySegment allocate(g_object_bind_property_full$transform_to fi, Arena scope) {
        return RuntimeHelper.upcallStub(constants$645.const$0, fi, constants$34.const$5, scope);
    }
    static g_object_bind_property_full$transform_to ofAddress(MemorySegment addr, Arena arena) {
