...
public class _GtkLevelBarClass {
    ...
    static final MethodHandle offset_changed$MH = RuntimeHelper.downcallHandle(
        _GtkLevelBarClass.offset_changed$FUNC
    );
    public interface offset_changed {

        void apply(java.lang.foreign.MemoryAddress _x0, java.lang.foreign.MemoryAddress _x1);
        static MemorySegment allocate(offset_changed fi, MemorySession session) {
            return RuntimeHelper.upcallStub(offset_changed.class, fi, _GtkLevelBarClass.offset_changed$FUNC, session);
        }
        static offset_changed ofAddress(MemoryAddress addr, MemorySession session) {
            MemorySegment symbol = MemorySegment.ofAddress(addr, 0, session);
            return (java.lang.foreign.MemoryAddress __x0, java.lang.foreign.MemoryAddress __x1) -> {
                try {
                    _GtkLevelBarClass.offset_changed$MH.invokeExact((Addressable)symbol, (java.lang.foreign.Addressable)__x0, (java.lang.foreign.Addressable)__x1);
                } catch (Throwable ex$) {
    ...
    public static MemoryAddress offset_changed$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)_GtkLevelBarClass.offset_changed$VH.get(seg);
    }
    public static void offset_changed$set( MemorySegment seg, MemoryAddress x) {
        _GtkLevelBarClass.offset_changed$VH.set(seg, x);
    }
    public static MemoryAddress offset_changed$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)_GtkLevelBarClass.offset_changed$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void offset_changed$set(MemorySegment seg, long index, MemoryAddress x) {
        _GtkLevelBarClass.offset_changed$VH.set(seg.asSlice(index*sizeof()), x);
    }
    public static offset_changed offset_changed (MemorySegment segment, MemorySession session) {
        return offset_changed.ofAddress(offset_changed$get(segment), session);
    }
