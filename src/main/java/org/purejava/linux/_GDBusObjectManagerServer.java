...
public class _GDBusObjectManagerServer {
    ...
    public static MemorySegment priv$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)_GDBusObjectManagerServer.priv$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment priv$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)_GDBusObjectManagerServer.priv$VH.get(seg.asSlice(index*sizeof()));
    }
