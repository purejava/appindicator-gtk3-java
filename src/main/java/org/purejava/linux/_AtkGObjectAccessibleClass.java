...
public class _AtkGObjectAccessibleClass {
    ...
    public static MemoryAddress pad1$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)_AtkGObjectAccessibleClass.pad1$VH.get(seg);
    }
    ...
    public static MemoryAddress pad1$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)_AtkGObjectAccessibleClass.pad1$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress pad2$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)_AtkGObjectAccessibleClass.pad2$VH.get(seg);
    }
    ...
    public static MemoryAddress pad2$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)_AtkGObjectAccessibleClass.pad2$VH.get(seg.asSlice(index*sizeof()));
    }
