...
public class _GtkHandleBox {
    ...
    public static MemoryLayout $LAYOUT() {
        return _GtkHandleBox.$struct$LAYOUT;
    }
    ...
    public static VarHandle priv$VH() {
        return _GtkHandleBox.priv$VH;
    }
    public static MemoryAddress priv$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)_GtkHandleBox.priv$VH.get(seg);
    }
    public static void priv$set( MemorySegment seg, MemoryAddress x) {
        _GtkHandleBox.priv$VH.set(seg, x);
    }
    public static MemoryAddress priv$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)_GtkHandleBox.priv$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void priv$set(MemorySegment seg, long index, MemoryAddress x) {
        _GtkHandleBox.priv$VH.set(seg.asSlice(index*sizeof()), x);
    }
