...
public class _GtkCheckMenuItem {
    ...
    public static MemoryLayout $LAYOUT() {
        return _GtkCheckMenuItem.$struct$LAYOUT;
    }
    ...
    public static VarHandle priv$VH() {
        return _GtkCheckMenuItem.priv$VH;
    }
    public static MemoryAddress priv$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)_GtkCheckMenuItem.priv$VH.get(seg);
    }
    public static void priv$set( MemorySegment seg, MemoryAddress x) {
        _GtkCheckMenuItem.priv$VH.set(seg, x);
    }
    public static MemoryAddress priv$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)_GtkCheckMenuItem.priv$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void priv$set(MemorySegment seg, long index, MemoryAddress x) {
        _GtkCheckMenuItem.priv$VH.set(seg.asSlice(index*sizeof()), x);
    }
