...
final class constants$1949 {
    ...
    static final MethodHandle gtk_rc_reparse_all$MH = RuntimeHelper.downcallHandle(
        "gtk_rc_reparse_all",
        constants$1949.gtk_rc_reparse_all$FUNC
    );
    ...
    static final MethodHandle gtk_rc_style_get_type$MH = RuntimeHelper.downcallHandle(
        ...
        constants$1949.gtk_rc_style_get_type$FUNC
    );
    ...
    static final MethodHandle gtk_rc_style_new$MH = RuntimeHelper.downcallHandle(
        "gtk_rc_style_new",
        constants$1949.gtk_rc_style_new$FUNC
    );
    ...
    static final MethodHandle gtk_rc_style_copy$MH = RuntimeHelper.downcallHandle(
        "gtk_rc_style_copy",
        constants$1949.gtk_rc_style_copy$FUNC
    );
    ...
    static final MethodHandle gtk_rc_find_module_in_path$MH = RuntimeHelper.downcallHandle(
        ...
        constants$1949.gtk_rc_find_module_in_path$FUNC
    );
    ...
    static final MethodHandle gtk_rc_get_theme_dir$MH = RuntimeHelper.downcallHandle(
        ...
        constants$1949.gtk_rc_get_theme_dir$FUNC
    );
}
