...
public class _GtkToggleAction {
    ...
    public static MemoryAddress private_data$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)_GtkToggleAction.private_data$VH.get(seg);
    }
    ...
    public static MemoryAddress private_data$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)_GtkToggleAction.private_data$VH.get(seg.asSlice(index*sizeof()));
    }
