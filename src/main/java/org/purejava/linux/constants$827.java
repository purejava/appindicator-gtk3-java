...
final class constants$827 {
    ...
    static final MethodHandle g_volume_get_mount$MH = RuntimeHelper.downcallHandle(
        "g_volume_get_mount",
        constants$827.g_volume_get_mount$FUNC
    );
    ...
    static final MethodHandle g_volume_can_mount$MH = RuntimeHelper.downcallHandle(
        "g_volume_can_mount",
        constants$827.g_volume_can_mount$FUNC
    );
    ...
    static final MethodHandle g_volume_can_eject$MH = RuntimeHelper.downcallHandle(
        "g_volume_can_eject",
        constants$827.g_volume_can_eject$FUNC
    );
    ...
    static final MethodHandle g_volume_should_automount$MH = RuntimeHelper.downcallHandle(
        ...
        constants$827.g_volume_should_automount$FUNC
    );
    ...
    static final MethodHandle g_volume_mount$MH = RuntimeHelper.downcallHandle(
        "g_volume_mount",
        constants$827.g_volume_mount$FUNC
    );
    ...
    static final MethodHandle g_volume_mount_finish$MH = RuntimeHelper.downcallHandle(
        ...
        constants$827.g_volume_mount_finish$FUNC
    );
}
