...
public class _GtkOverlay {
    ...
    public static MemoryAddress priv$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)_GtkOverlay.priv$VH.get(seg);
    }
    ...
    public static MemoryAddress priv$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)_GtkOverlay.priv$VH.get(seg.asSlice(index*sizeof()));
    }
