...
public class _GtkToolbarClass {
    ...
    static final MethodHandle orientation_changed$MH = RuntimeHelper.downcallHandle(
        _GtkToolbarClass.orientation_changed$FUNC
    );
    public interface orientation_changed {

        void apply(java.lang.foreign.MemoryAddress _x0, int _x1);
        static MemorySegment allocate(orientation_changed fi, MemorySession session) {
            return RuntimeHelper.upcallStub(orientation_changed.class, fi, _GtkToolbarClass.orientation_changed$FUNC, session);
        }
        static orientation_changed ofAddress(MemoryAddress addr, MemorySession session) {
            MemorySegment symbol = MemorySegment.ofAddress(addr, 0, session);
            return (java.lang.foreign.MemoryAddress __x0, int __x1) -> {
                try {
                    _GtkToolbarClass.orientation_changed$MH.invokeExact((Addressable)symbol, (java.lang.foreign.Addressable)__x0, __x1);
                } catch (Throwable ex$) {
    ...
    public static MemoryAddress orientation_changed$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)_GtkToolbarClass.orientation_changed$VH.get(seg);
    }
    public static void orientation_changed$set( MemorySegment seg, MemoryAddress x) {
        _GtkToolbarClass.orientation_changed$VH.set(seg, x);
    }
    public static MemoryAddress orientation_changed$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)_GtkToolbarClass.orientation_changed$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void orientation_changed$set(MemorySegment seg, long index, MemoryAddress x) {
        _GtkToolbarClass.orientation_changed$VH.set(seg.asSlice(index*sizeof()), x);
    }
    public static orientation_changed orientation_changed (MemorySegment segment, MemorySession session) {
        return orientation_changed.ofAddress(orientation_changed$get(segment), session);
    }
    static final FunctionDescriptor style_changed$FUNC = FunctionDescriptor.ofVoid(
        Constants$root.C_POINTER$LAYOUT,
        Constants$root.C_INT$LAYOUT
    );
    static final MethodHandle style_changed$MH = RuntimeHelper.downcallHandle(
        _GtkToolbarClass.style_changed$FUNC
    );
    public interface style_changed {

        void apply(java.lang.foreign.MemoryAddress _x0, int _x1);
        static MemorySegment allocate(style_changed fi, MemorySession session) {
            return RuntimeHelper.upcallStub(style_changed.class, fi, _GtkToolbarClass.style_changed$FUNC, session);
        }
        static style_changed ofAddress(MemoryAddress addr, MemorySession session) {
            MemorySegment symbol = MemorySegment.ofAddress(addr, 0, session);
            return (java.lang.foreign.MemoryAddress __x0, int __x1) -> {
                try {
                    _GtkToolbarClass.style_changed$MH.invokeExact((Addressable)symbol, (java.lang.foreign.Addressable)__x0, __x1);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
    ...
    public static MemoryAddress style_changed$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)_GtkToolbarClass.style_changed$VH.get(seg);
    }
    public static void style_changed$set( MemorySegment seg, MemoryAddress x) {
        _GtkToolbarClass.style_changed$VH.set(seg, x);
    }
    public static MemoryAddress style_changed$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)_GtkToolbarClass.style_changed$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void style_changed$set(MemorySegment seg, long index, MemoryAddress x) {
        _GtkToolbarClass.style_changed$VH.set(seg.asSlice(index*sizeof()), x);
    }
    public static style_changed style_changed (MemorySegment segment, MemorySession session) {
        return style_changed.ofAddress(style_changed$get(segment), session);
    }
    ...
    static final MethodHandle popup_context_menu$MH = RuntimeHelper.downcallHandle(
        _GtkToolbarClass.popup_context_menu$FUNC
    );
    public interface popup_context_menu {

        int apply(java.lang.foreign.MemoryAddress _x0, int _x1, int _x2, int _x3);
        static MemorySegment allocate(popup_context_menu fi, MemorySession session) {
            return RuntimeHelper.upcallStub(popup_context_menu.class, fi, _GtkToolbarClass.popup_context_menu$FUNC, session);
        }
        static popup_context_menu ofAddress(MemoryAddress addr, MemorySession session) {
            MemorySegment symbol = MemorySegment.ofAddress(addr, 0, session);
            return (java.lang.foreign.MemoryAddress __x0, int __x1, int __x2, int __x3) -> {
                try {
                    return (int)_GtkToolbarClass.popup_context_menu$MH.invokeExact((Addressable)symbol, (java.lang.foreign.Addressable)__x0, __x1, __x2, __x3);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
    ...
    public static MemoryAddress popup_context_menu$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)_GtkToolbarClass.popup_context_menu$VH.get(seg);
    }
    public static void popup_context_menu$set( MemorySegment seg, MemoryAddress x) {
        _GtkToolbarClass.popup_context_menu$VH.set(seg, x);
    }
    public static MemoryAddress popup_context_menu$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)_GtkToolbarClass.popup_context_menu$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void popup_context_menu$set(MemorySegment seg, long index, MemoryAddress x) {
        _GtkToolbarClass.popup_context_menu$VH.set(seg.asSlice(index*sizeof()), x);
    }
    public static popup_context_menu popup_context_menu (MemorySegment segment, MemorySession session) {
        return popup_context_menu.ofAddress(popup_context_menu$get(segment), session);
    }
    static final FunctionDescriptor _gtk_reserved1$FUNC = FunctionDescriptor.ofVoid();
    static final MethodHandle _gtk_reserved1$MH = RuntimeHelper.downcallHandle(
        _GtkToolbarClass._gtk_reserved1$FUNC
    );
    public interface _gtk_reserved1 {

        void apply();
        static MemorySegment allocate(_gtk_reserved1 fi, MemorySession session) {
            return RuntimeHelper.upcallStub(_gtk_reserved1.class, fi, _GtkToolbarClass._gtk_reserved1$FUNC, session);
        }
        static _gtk_reserved1 ofAddress(MemoryAddress addr, MemorySession session) {
            MemorySegment symbol = MemorySegment.ofAddress(addr, 0, session);
            return () -> {
                try {
                    _GtkToolbarClass._gtk_reserved1$MH.invokeExact((Addressable)symbol);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
    ...
    public static MemoryAddress _gtk_reserved1$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)_GtkToolbarClass._gtk_reserved1$VH.get(seg);
    }
    ...
    public static MemoryAddress _gtk_reserved1$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)_GtkToolbarClass._gtk_reserved1$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    static final MethodHandle _gtk_reserved2$MH = RuntimeHelper.downcallHandle(
        _GtkToolbarClass._gtk_reserved2$FUNC
    );
    public interface _gtk_reserved2 {

        void apply();
        static MemorySegment allocate(_gtk_reserved2 fi, MemorySession session) {
            return RuntimeHelper.upcallStub(_gtk_reserved2.class, fi, _GtkToolbarClass._gtk_reserved2$FUNC, session);
        }
        static _gtk_reserved2 ofAddress(MemoryAddress addr, MemorySession session) {
            MemorySegment symbol = MemorySegment.ofAddress(addr, 0, session);
            return () -> {
                try {
                    _GtkToolbarClass._gtk_reserved2$MH.invokeExact((Addressable)symbol);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
    ...
    public static MemoryAddress _gtk_reserved2$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)_GtkToolbarClass._gtk_reserved2$VH.get(seg);
    }
    ...
    public static MemoryAddress _gtk_reserved2$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)_GtkToolbarClass._gtk_reserved2$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    static final MethodHandle _gtk_reserved3$MH = RuntimeHelper.downcallHandle(
        _GtkToolbarClass._gtk_reserved3$FUNC
    );
    public interface _gtk_reserved3 {

        void apply();
        static MemorySegment allocate(_gtk_reserved3 fi, MemorySession session) {
            return RuntimeHelper.upcallStub(_gtk_reserved3.class, fi, _GtkToolbarClass._gtk_reserved3$FUNC, session);
        }
        static _gtk_reserved3 ofAddress(MemoryAddress addr, MemorySession session) {
            MemorySegment symbol = MemorySegment.ofAddress(addr, 0, session);
            return () -> {
                try {
                    _GtkToolbarClass._gtk_reserved3$MH.invokeExact((Addressable)symbol);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
    ...
    public static MemoryAddress _gtk_reserved3$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)_GtkToolbarClass._gtk_reserved3$VH.get(seg);
    }
    ...
    public static MemoryAddress _gtk_reserved3$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)_GtkToolbarClass._gtk_reserved3$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    static final MethodHandle _gtk_reserved4$MH = RuntimeHelper.downcallHandle(
        _GtkToolbarClass._gtk_reserved4$FUNC
    );
    public interface _gtk_reserved4 {

        void apply();
        static MemorySegment allocate(_gtk_reserved4 fi, MemorySession session) {
            return RuntimeHelper.upcallStub(_gtk_reserved4.class, fi, _GtkToolbarClass._gtk_reserved4$FUNC, session);
        }
        static _gtk_reserved4 ofAddress(MemoryAddress addr, MemorySession session) {
            MemorySegment symbol = MemorySegment.ofAddress(addr, 0, session);
            return () -> {
                try {
                    _GtkToolbarClass._gtk_reserved4$MH.invokeExact((Addressable)symbol);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
    ...
    public static MemoryAddress _gtk_reserved4$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)_GtkToolbarClass._gtk_reserved4$VH.get(seg);
    }
    ...
    public static MemoryAddress _gtk_reserved4$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)_GtkToolbarClass._gtk_reserved4$VH.get(seg.asSlice(index*sizeof()));
    }
