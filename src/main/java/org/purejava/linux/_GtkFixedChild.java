...
public class _GtkFixedChild {
    ...
    public static MemoryAddress widget$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)_GtkFixedChild.widget$VH.get(seg);
    }
    ...
    public static MemoryAddress widget$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)_GtkFixedChild.widget$VH.get(seg.asSlice(index*sizeof()));
    }
