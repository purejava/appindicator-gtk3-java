...
public interface hb_font_get_glyph_advances_func_t {
    ...
    static MemorySegment allocate(hb_font_get_glyph_advances_func_t fi, SegmentScope scope) {
        return RuntimeHelper.upcallStub(constants$861.hb_font_get_glyph_advances_func_t_UP$MH, fi, constants$861.hb_font_get_glyph_advances_func_t$FUNC, scope);
    }
    static hb_font_get_glyph_advances_func_t ofAddress(MemorySegment addr, SegmentScope scope) {
        ...
        return (java.lang.foreign.MemorySegment _font, java.lang.foreign.MemorySegment _font_data, int _count, java.lang.foreign.MemorySegment _first_glyph, int _glyph_stride, java.lang.foreign.MemorySegment _first_advance, int _advance_stride, java.lang.foreign.MemorySegment _user_data) -> {
            try {
                constants$861.hb_font_get_glyph_advances_func_t_DOWN$MH.invokeExact(symbol, _font, _font_data, _count, _first_glyph, _glyph_stride, _first_advance, _advance_stride, _user_data);
            } catch (Throwable ex$) {
