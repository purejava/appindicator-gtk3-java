...
public class _GtkTextChildAnchor {
    ...
    public static MemorySegment segment$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)_GtkTextChildAnchor.segment$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment segment$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)_GtkTextChildAnchor.segment$VH.get(seg.asSlice(index*sizeof()));
    }
