...
public class _GtkAccelLabelClass {
    ...
    static final  GroupLayout $struct$LAYOUT = MemoryLayout.structLayout(
        ...
        Constants$root.C_POINTER$LAYOUT.withName("signal_quote1"),
        Constants$root.C_POINTER$LAYOUT.withName("signal_quote2"),
        Constants$root.C_POINTER$LAYOUT.withName("mod_name_shift"),
        Constants$root.C_POINTER$LAYOUT.withName("mod_name_control"),
        Constants$root.C_POINTER$LAYOUT.withName("mod_name_alt"),
        Constants$root.C_POINTER$LAYOUT.withName("mod_separator"),
        Constants$root.C_POINTER$LAYOUT.withName("_gtk_reserved1"),
        Constants$root.C_POINTER$LAYOUT.withName("_gtk_reserved2"),
        Constants$root.C_POINTER$LAYOUT.withName("_gtk_reserved3"),
        Constants$root.C_POINTER$LAYOUT.withName("_gtk_reserved4")
    ...
    public static MemoryLayout $LAYOUT() {
        return _GtkAccelLabelClass.$struct$LAYOUT;
    }
    public static MemorySegment parent_class$slice(MemorySegment seg) {
        return seg.asSlice(0, 952);
    }
    static final VarHandle signal_quote1$VH = $struct$LAYOUT.varHandle(MemoryLayout.PathElement.groupElement("signal_quote1"));
    public static VarHandle signal_quote1$VH() {
        return _GtkAccelLabelClass.signal_quote1$VH;
    }
    public static MemoryAddress signal_quote1$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)_GtkAccelLabelClass.signal_quote1$VH.get(seg);
    }
    public static void signal_quote1$set( MemorySegment seg, MemoryAddress x) {
        _GtkAccelLabelClass.signal_quote1$VH.set(seg, x);
    }
    public static MemoryAddress signal_quote1$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)_GtkAccelLabelClass.signal_quote1$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void signal_quote1$set(MemorySegment seg, long index, MemoryAddress x) {
        _GtkAccelLabelClass.signal_quote1$VH.set(seg.asSlice(index*sizeof()), x);
    }
    static final VarHandle signal_quote2$VH = $struct$LAYOUT.varHandle(MemoryLayout.PathElement.groupElement("signal_quote2"));
    public static VarHandle signal_quote2$VH() {
        return _GtkAccelLabelClass.signal_quote2$VH;
    }
    public static MemoryAddress signal_quote2$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)_GtkAccelLabelClass.signal_quote2$VH.get(seg);
    }
    public static void signal_quote2$set( MemorySegment seg, MemoryAddress x) {
        _GtkAccelLabelClass.signal_quote2$VH.set(seg, x);
    }
    public static MemoryAddress signal_quote2$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)_GtkAccelLabelClass.signal_quote2$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void signal_quote2$set(MemorySegment seg, long index, MemoryAddress x) {
        _GtkAccelLabelClass.signal_quote2$VH.set(seg.asSlice(index*sizeof()), x);
    }
    static final VarHandle mod_name_shift$VH = $struct$LAYOUT.varHandle(MemoryLayout.PathElement.groupElement("mod_name_shift"));
    public static VarHandle mod_name_shift$VH() {
        return _GtkAccelLabelClass.mod_name_shift$VH;
    }
    public static MemoryAddress mod_name_shift$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)_GtkAccelLabelClass.mod_name_shift$VH.get(seg);
    }
    public static void mod_name_shift$set( MemorySegment seg, MemoryAddress x) {
        _GtkAccelLabelClass.mod_name_shift$VH.set(seg, x);
    }
    public static MemoryAddress mod_name_shift$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)_GtkAccelLabelClass.mod_name_shift$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void mod_name_shift$set(MemorySegment seg, long index, MemoryAddress x) {
        _GtkAccelLabelClass.mod_name_shift$VH.set(seg.asSlice(index*sizeof()), x);
    }
    static final VarHandle mod_name_control$VH = $struct$LAYOUT.varHandle(MemoryLayout.PathElement.groupElement("mod_name_control"));
    public static VarHandle mod_name_control$VH() {
        return _GtkAccelLabelClass.mod_name_control$VH;
    }
    public static MemoryAddress mod_name_control$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)_GtkAccelLabelClass.mod_name_control$VH.get(seg);
    }
    public static void mod_name_control$set( MemorySegment seg, MemoryAddress x) {
        _GtkAccelLabelClass.mod_name_control$VH.set(seg, x);
    }
    public static MemoryAddress mod_name_control$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)_GtkAccelLabelClass.mod_name_control$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void mod_name_control$set(MemorySegment seg, long index, MemoryAddress x) {
        _GtkAccelLabelClass.mod_name_control$VH.set(seg.asSlice(index*sizeof()), x);
    }
    static final VarHandle mod_name_alt$VH = $struct$LAYOUT.varHandle(MemoryLayout.PathElement.groupElement("mod_name_alt"));
    public static VarHandle mod_name_alt$VH() {
        return _GtkAccelLabelClass.mod_name_alt$VH;
    }
    public static MemoryAddress mod_name_alt$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)_GtkAccelLabelClass.mod_name_alt$VH.get(seg);
    }
    public static void mod_name_alt$set( MemorySegment seg, MemoryAddress x) {
        _GtkAccelLabelClass.mod_name_alt$VH.set(seg, x);
    }
    public static MemoryAddress mod_name_alt$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)_GtkAccelLabelClass.mod_name_alt$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void mod_name_alt$set(MemorySegment seg, long index, MemoryAddress x) {
        _GtkAccelLabelClass.mod_name_alt$VH.set(seg.asSlice(index*sizeof()), x);
    }
    static final VarHandle mod_separator$VH = $struct$LAYOUT.varHandle(MemoryLayout.PathElement.groupElement("mod_separator"));
    public static VarHandle mod_separator$VH() {
        return _GtkAccelLabelClass.mod_separator$VH;
    }
    public static MemoryAddress mod_separator$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)_GtkAccelLabelClass.mod_separator$VH.get(seg);
    }
    public static void mod_separator$set( MemorySegment seg, MemoryAddress x) {
        _GtkAccelLabelClass.mod_separator$VH.set(seg, x);
    }
    public static MemoryAddress mod_separator$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)_GtkAccelLabelClass.mod_separator$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void mod_separator$set(MemorySegment seg, long index, MemoryAddress x) {
        _GtkAccelLabelClass.mod_separator$VH.set(seg.asSlice(index*sizeof()), x);
    }
    static final FunctionDescriptor _gtk_reserved1$FUNC = FunctionDescriptor.ofVoid();
    static final MethodHandle _gtk_reserved1$MH = RuntimeHelper.downcallHandle(
        _GtkAccelLabelClass._gtk_reserved1$FUNC
    );
    public interface _gtk_reserved1 {

        void apply();
        static MemorySegment allocate(_gtk_reserved1 fi, MemorySession session) {
            return RuntimeHelper.upcallStub(_gtk_reserved1.class, fi, _GtkAccelLabelClass._gtk_reserved1$FUNC, session);
        }
        static _gtk_reserved1 ofAddress(MemoryAddress addr, MemorySession session) {
            MemorySegment symbol = MemorySegment.ofAddress(addr, 0, session);
            return () -> {
                try {
                    _GtkAccelLabelClass._gtk_reserved1$MH.invokeExact((Addressable)symbol);
                } catch (Throwable ex$) {
    ...
    public static VarHandle _gtk_reserved1$VH() {
        return _GtkAccelLabelClass._gtk_reserved1$VH;
    }
    public static MemoryAddress _gtk_reserved1$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)_GtkAccelLabelClass._gtk_reserved1$VH.get(seg);
    }
    public static void _gtk_reserved1$set( MemorySegment seg, MemoryAddress x) {
        _GtkAccelLabelClass._gtk_reserved1$VH.set(seg, x);
    }
    public static MemoryAddress _gtk_reserved1$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)_GtkAccelLabelClass._gtk_reserved1$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void _gtk_reserved1$set(MemorySegment seg, long index, MemoryAddress x) {
        _GtkAccelLabelClass._gtk_reserved1$VH.set(seg.asSlice(index*sizeof()), x);
    }
    ...
    static final MethodHandle _gtk_reserved2$MH = RuntimeHelper.downcallHandle(
        _GtkAccelLabelClass._gtk_reserved2$FUNC
    );
    public interface _gtk_reserved2 {

        void apply();
        static MemorySegment allocate(_gtk_reserved2 fi, MemorySession session) {
            return RuntimeHelper.upcallStub(_gtk_reserved2.class, fi, _GtkAccelLabelClass._gtk_reserved2$FUNC, session);
        }
        static _gtk_reserved2 ofAddress(MemoryAddress addr, MemorySession session) {
            MemorySegment symbol = MemorySegment.ofAddress(addr, 0, session);
            return () -> {
                try {
                    _GtkAccelLabelClass._gtk_reserved2$MH.invokeExact((Addressable)symbol);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
    ...
    public static VarHandle _gtk_reserved2$VH() {
        return _GtkAccelLabelClass._gtk_reserved2$VH;
    }
    public static MemoryAddress _gtk_reserved2$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)_GtkAccelLabelClass._gtk_reserved2$VH.get(seg);
    }
    public static void _gtk_reserved2$set( MemorySegment seg, MemoryAddress x) {
        _GtkAccelLabelClass._gtk_reserved2$VH.set(seg, x);
    }
    public static MemoryAddress _gtk_reserved2$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)_GtkAccelLabelClass._gtk_reserved2$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void _gtk_reserved2$set(MemorySegment seg, long index, MemoryAddress x) {
        _GtkAccelLabelClass._gtk_reserved2$VH.set(seg.asSlice(index*sizeof()), x);
    }
    ...
    static final MethodHandle _gtk_reserved3$MH = RuntimeHelper.downcallHandle(
        _GtkAccelLabelClass._gtk_reserved3$FUNC
    );
    public interface _gtk_reserved3 {

        void apply();
        static MemorySegment allocate(_gtk_reserved3 fi, MemorySession session) {
            return RuntimeHelper.upcallStub(_gtk_reserved3.class, fi, _GtkAccelLabelClass._gtk_reserved3$FUNC, session);
        }
        static _gtk_reserved3 ofAddress(MemoryAddress addr, MemorySession session) {
            MemorySegment symbol = MemorySegment.ofAddress(addr, 0, session);
            return () -> {
                try {
                    _GtkAccelLabelClass._gtk_reserved3$MH.invokeExact((Addressable)symbol);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
    ...
    public static VarHandle _gtk_reserved3$VH() {
        return _GtkAccelLabelClass._gtk_reserved3$VH;
    }
    public static MemoryAddress _gtk_reserved3$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)_GtkAccelLabelClass._gtk_reserved3$VH.get(seg);
    }
    public static void _gtk_reserved3$set( MemorySegment seg, MemoryAddress x) {
        _GtkAccelLabelClass._gtk_reserved3$VH.set(seg, x);
    }
    public static MemoryAddress _gtk_reserved3$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)_GtkAccelLabelClass._gtk_reserved3$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void _gtk_reserved3$set(MemorySegment seg, long index, MemoryAddress x) {
        _GtkAccelLabelClass._gtk_reserved3$VH.set(seg.asSlice(index*sizeof()), x);
    }
    ...
    static final MethodHandle _gtk_reserved4$MH = RuntimeHelper.downcallHandle(
        _GtkAccelLabelClass._gtk_reserved4$FUNC
    );
    public interface _gtk_reserved4 {

        void apply();
        static MemorySegment allocate(_gtk_reserved4 fi, MemorySession session) {
            return RuntimeHelper.upcallStub(_gtk_reserved4.class, fi, _GtkAccelLabelClass._gtk_reserved4$FUNC, session);
        }
        static _gtk_reserved4 ofAddress(MemoryAddress addr, MemorySession session) {
            MemorySegment symbol = MemorySegment.ofAddress(addr, 0, session);
            return () -> {
                try {
                    _GtkAccelLabelClass._gtk_reserved4$MH.invokeExact((Addressable)symbol);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
    ...
    public static VarHandle _gtk_reserved4$VH() {
        return _GtkAccelLabelClass._gtk_reserved4$VH;
    }
    public static MemoryAddress _gtk_reserved4$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)_GtkAccelLabelClass._gtk_reserved4$VH.get(seg);
    }
    public static void _gtk_reserved4$set( MemorySegment seg, MemoryAddress x) {
        _GtkAccelLabelClass._gtk_reserved4$VH.set(seg, x);
    }
    public static MemoryAddress _gtk_reserved4$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)_GtkAccelLabelClass._gtk_reserved4$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void _gtk_reserved4$set(MemorySegment seg, long index, MemoryAddress x) {
        _GtkAccelLabelClass._gtk_reserved4$VH.set(seg.asSlice(index*sizeof()), x);
    }
