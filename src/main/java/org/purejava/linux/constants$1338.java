...
class constants$1338 {
    ...
    static final MethodHandle gdk_keyval_to_lower$MH = RuntimeHelper.downcallHandle(
        "gdk_keyval_to_lower",
        constants$1338.gdk_keyval_to_lower$FUNC
    );
    ...
    static final MethodHandle gdk_keyval_is_upper$MH = RuntimeHelper.downcallHandle(
        "gdk_keyval_is_upper",
        constants$1338.gdk_keyval_is_upper$FUNC
    );
    ...
    static final MethodHandle gdk_keyval_is_lower$MH = RuntimeHelper.downcallHandle(
        "gdk_keyval_is_lower",
        constants$1338.gdk_keyval_is_lower$FUNC
    );
    ...
    static final MethodHandle gdk_keyval_to_unicode$MH = RuntimeHelper.downcallHandle(
        ...
        constants$1338.gdk_keyval_to_unicode$FUNC
    );
    ...
    static final MethodHandle gdk_unicode_to_keyval$MH = RuntimeHelper.downcallHandle(
        ...
        constants$1338.gdk_unicode_to_keyval$FUNC
    );
    ...
    static final MethodHandle gdk_parse_args$MH = RuntimeHelper.downcallHandle(
        "gdk_parse_args",
        constants$1338.gdk_parse_args$FUNC
    );
}
