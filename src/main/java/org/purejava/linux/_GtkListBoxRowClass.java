...
public class _GtkListBoxRowClass {
    ...
    static final MethodHandle activate_UP$MH = RuntimeHelper.upcallHandle(activate.class, "apply", _GtkListBoxRowClass.activate_UP$FUNC);
    ...
    static final MethodHandle activate_DOWN$MH = RuntimeHelper.downcallHandle(
        _GtkListBoxRowClass.activate_DOWN$FUNC
    );
    /**
     * {@snippet :
 * void (*activate)(GtkListBoxRow*);
    ...
    public interface activate {
        ...
        static MemorySegment allocate(activate fi, SegmentScope scope) {
            return RuntimeHelper.upcallStub(_GtkListBoxRowClass.activate_UP$MH, fi, _GtkListBoxRowClass.activate$FUNC, scope);
        }
        static activate ofAddress(MemorySegment addr, SegmentScope scope) {
            MemorySegment symbol = MemorySegment.ofAddress(addr.address(), 0, scope);
            return (java.lang.foreign.MemorySegment _display) -> {
                try {
                    _GtkListBoxRowClass.activate_DOWN$MH.invokeExact(symbol, _display);
                } catch (Throwable ex$) {
    ...
    public static MemorySegment activate$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)_GtkListBoxRowClass.activate$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment activate$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)_GtkListBoxRowClass.activate$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    static final MethodHandle _gtk_reserved1_UP$MH = RuntimeHelper.upcallHandle(_gtk_reserved1.class, "apply", _GtkListBoxRowClass._gtk_reserved1_UP$FUNC);
    ...
    static final MethodHandle _gtk_reserved1_DOWN$MH = RuntimeHelper.downcallHandle(
        _GtkListBoxRowClass._gtk_reserved1_DOWN$FUNC
    );
    /**
     * {@snippet :
 * void (*_gtk_reserved1)();
    ...
    public interface _gtk_reserved1 {
        ...
        static MemorySegment allocate(_gtk_reserved1 fi, SegmentScope scope) {
            return RuntimeHelper.upcallStub(_GtkListBoxRowClass._gtk_reserved1_UP$MH, fi, _GtkListBoxRowClass._gtk_reserved1$FUNC, scope);
        }
        static _gtk_reserved1 ofAddress(MemorySegment addr, SegmentScope scope) {
            MemorySegment symbol = MemorySegment.ofAddress(addr.address(), 0, scope);
            return () -> {
                try {
                    _GtkListBoxRowClass._gtk_reserved1_DOWN$MH.invokeExact(symbol);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
    ...
    public static VarHandle _gtk_reserved1$VH() {
        return _GtkListBoxRowClass._gtk_reserved1$VH;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static MemorySegment _gtk_reserved1$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)_GtkListBoxRowClass._gtk_reserved1$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void _gtk_reserved1$set(MemorySegment seg, MemorySegment x) {
        _GtkListBoxRowClass._gtk_reserved1$VH.set(seg, x);
    }
    public static MemorySegment _gtk_reserved1$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)_GtkListBoxRowClass._gtk_reserved1$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void _gtk_reserved1$set(MemorySegment seg, long index, MemorySegment x) {
        _GtkListBoxRowClass._gtk_reserved1$VH.set(seg.asSlice(index*sizeof()), x);
    }
    ...
    static final MethodHandle _gtk_reserved2_UP$MH = RuntimeHelper.upcallHandle(_gtk_reserved2.class, "apply", _GtkListBoxRowClass._gtk_reserved2_UP$FUNC);
    ...
    static final MethodHandle _gtk_reserved2_DOWN$MH = RuntimeHelper.downcallHandle(
        _GtkListBoxRowClass._gtk_reserved2_DOWN$FUNC
    );
    /**
     * {@snippet :
 * void (*_gtk_reserved2)();
    ...
    public interface _gtk_reserved2 {
        ...
        static MemorySegment allocate(_gtk_reserved2 fi, SegmentScope scope) {
            return RuntimeHelper.upcallStub(_GtkListBoxRowClass._gtk_reserved2_UP$MH, fi, _GtkListBoxRowClass._gtk_reserved2$FUNC, scope);
        }
        static _gtk_reserved2 ofAddress(MemorySegment addr, SegmentScope scope) {
            MemorySegment symbol = MemorySegment.ofAddress(addr.address(), 0, scope);
            return () -> {
                try {
                    _GtkListBoxRowClass._gtk_reserved2_DOWN$MH.invokeExact(symbol);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
    ...
    public static VarHandle _gtk_reserved2$VH() {
        return _GtkListBoxRowClass._gtk_reserved2$VH;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static MemorySegment _gtk_reserved2$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)_GtkListBoxRowClass._gtk_reserved2$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void _gtk_reserved2$set(MemorySegment seg, MemorySegment x) {
        _GtkListBoxRowClass._gtk_reserved2$VH.set(seg, x);
    }
    public static MemorySegment _gtk_reserved2$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)_GtkListBoxRowClass._gtk_reserved2$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void _gtk_reserved2$set(MemorySegment seg, long index, MemorySegment x) {
        _GtkListBoxRowClass._gtk_reserved2$VH.set(seg.asSlice(index*sizeof()), x);
    }
