...
public class _GdkEventTouchpadPinch {
    ...
    public static MemoryAddress window$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)_GdkEventTouchpadPinch.window$VH.get(seg);
    }
    ...
    public static MemoryAddress window$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)_GdkEventTouchpadPinch.window$VH.get(seg.asSlice(index*sizeof()));
    }
