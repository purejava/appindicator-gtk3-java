...
public class _GtkPopover {
    ...
    public static MemoryAddress priv$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)_GtkPopover.priv$VH.get(seg);
    }
    ...
    public static MemoryAddress priv$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)_GtkPopover.priv$VH.get(seg.asSlice(index*sizeof()));
    }
