...
public class _GtkUIManager {
    ...
    public static MemoryAddress private_data$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)_GtkUIManager.private_data$VH.get(seg);
    }
    ...
    public static MemoryAddress private_data$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)_GtkUIManager.private_data$VH.get(seg.asSlice(index*sizeof()));
    }
