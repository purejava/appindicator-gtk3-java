...
public class _GtkUIManager {
    ...
    ).withName("_GtkUIManager");
    public static MemoryLayout $LAYOUT() {
        return _GtkUIManager.$struct$LAYOUT;
    }
    ...
    public static VarHandle private_data$VH() {
        return _GtkUIManager.private_data$VH;
    }
    /**
     * Getter for field:
     * {@snippet :
    ...
    public static MemorySegment private_data$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)_GtkUIManager.private_data$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void private_data$set(MemorySegment seg, MemorySegment x) {
        _GtkUIManager.private_data$VH.set(seg, x);
    }
    public static MemorySegment private_data$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)_GtkUIManager.private_data$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void private_data$set(MemorySegment seg, long index, MemorySegment x) {
        _GtkUIManager.private_data$VH.set(seg.asSlice(index*sizeof()), x);
    }
