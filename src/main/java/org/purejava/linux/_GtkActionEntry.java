...
public class _GtkActionEntry {
    ...
    public static MemoryAddress name$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)_GtkActionEntry.name$VH.get(seg);
    }
    ...
    public static MemoryAddress name$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)_GtkActionEntry.name$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress stock_id$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)_GtkActionEntry.stock_id$VH.get(seg);
    }
    ...
    public static MemoryAddress stock_id$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)_GtkActionEntry.stock_id$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress label$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)_GtkActionEntry.label$VH.get(seg);
    }
    ...
    public static MemoryAddress label$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)_GtkActionEntry.label$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress accelerator$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)_GtkActionEntry.accelerator$VH.get(seg);
    }
    ...
    public static MemoryAddress accelerator$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)_GtkActionEntry.accelerator$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress tooltip$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)_GtkActionEntry.tooltip$VH.get(seg);
    }
    ...
    public static MemoryAddress tooltip$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)_GtkActionEntry.tooltip$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress callback$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)_GtkActionEntry.callback$VH.get(seg);
    }
    ...
    public static MemoryAddress callback$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)_GtkActionEntry.callback$VH.get(seg.asSlice(index*sizeof()));
    }
