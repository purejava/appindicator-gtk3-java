...
public class _GtkEntryCompletion {
    ...
    public static MemoryLayout $LAYOUT() {
        return _GtkEntryCompletion.$struct$LAYOUT;
    }
    ...
    public static VarHandle priv$VH() {
        return _GtkEntryCompletion.priv$VH;
    }
    public static MemoryAddress priv$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)_GtkEntryCompletion.priv$VH.get(seg);
    }
    public static void priv$set( MemorySegment seg, MemoryAddress x) {
        _GtkEntryCompletion.priv$VH.set(seg, x);
    }
    public static MemoryAddress priv$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)_GtkEntryCompletion.priv$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void priv$set(MemorySegment seg, long index, MemoryAddress x) {
        _GtkEntryCompletion.priv$VH.set(seg.asSlice(index*sizeof()), x);
    }
