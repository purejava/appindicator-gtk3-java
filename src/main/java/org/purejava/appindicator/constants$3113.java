...
final class constants$3113 {
    ...
    static final VarHandle const$3 = constants$3113.const$2.varHandle(MemoryLayout.PathElement.groupElement("priv"));
    static final StructLayout const$4 = MemoryLayout.structLayout(
        ...
        RuntimeHelper.POINTER.withName("text_pushed"),
        RuntimeHelper.POINTER.withName("text_popped"),
        RuntimeHelper.POINTER.withName("_gtk_reserved1"),
        RuntimeHelper.POINTER.withName("_gtk_reserved2"),
        RuntimeHelper.POINTER.withName("_gtk_reserved3"),
        RuntimeHelper.POINTER.withName("_gtk_reserved4")
    ).withName("_GtkStatusbarClass");
    static final VarHandle const$5 = constants$3113.const$4.varHandle(MemoryLayout.PathElement.groupElement("reserved"));
}
