...
final class constants$3097 {
    ...
    static final MethodHandle const$3 = RuntimeHelper.upcallHandle(_GtkStackSidebarClass._gtk_reserved1.class, "apply", constants$7.const$5);
    static final VarHandle const$4 = constants$3097.const$2.varHandle(MemoryLayout.PathElement.groupElement("_gtk_reserved1"));
    static final MethodHandle const$5 = RuntimeHelper.upcallHandle(_GtkStackSidebarClass._gtk_reserved2.class, "apply", constants$7.const$5);
}
