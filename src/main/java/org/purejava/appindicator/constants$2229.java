...
final class constants$2229 {
    ...
    static final VarHandle const$0 = constants$2228.const$5.varHandle(MemoryLayout.PathElement.groupElement("priv"));
    ...
    static final MethodHandle const$2 = RuntimeHelper.upcallHandle(_GtkMiscClass._gtk_reserved1.class, "apply", constants$7.const$5);
    static final VarHandle const$3 = constants$2229.const$1.varHandle(MemoryLayout.PathElement.groupElement("_gtk_reserved1"));
    static final MethodHandle const$4 = RuntimeHelper.upcallHandle(_GtkMiscClass._gtk_reserved2.class, "apply", constants$7.const$5);
    static final VarHandle const$5 = constants$2229.const$1.varHandle(MemoryLayout.PathElement.groupElement("_gtk_reserved2"));
}
