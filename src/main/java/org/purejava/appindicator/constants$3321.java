...
final class constants$3321 {
    ...
    static final VarHandle const$3 = constants$3321.const$2.varHandle(MemoryLayout.PathElement.groupElement("name"));
    static final VarHandle const$4 = constants$3321.const$2.varHandle(MemoryLayout.PathElement.groupElement("font_desc"));
    static final VarHandle const$5 = constants$3321.const$2.varHandle(MemoryLayout.PathElement.groupElement("xthickness"));
}
