...
public class _GTlsCertificateClass {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        app_indicator_h.C_POINTER.withName("verify"),
    ...
    public final static class verify {
        ...
        private static final MethodHandle UP$MH = app_indicator_h.upcallHandle(verify.Function.class, "apply", $DESC);

        /**
         * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
         * The lifetime of the returned segment is managed by {@code arena}
         */
        public static MemorySegment allocate(verify.Function fi, Arena arena) {
    ...
    private static final AddressLayout verify$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("verify"));
     ...
     * }
     */
    public static final AddressLayout verify$layout() {
        return verify$LAYOUT;
    }

    private static final long verify$OFFSET = $LAYOUT.byteOffset(groupElement("verify"));
     ...
     * }
     */
    public static MemorySegment verify(MemorySegment struct) {
     ...
     * }
     */
    public static void verify(MemorySegment struct, MemorySegment fieldValue) {
