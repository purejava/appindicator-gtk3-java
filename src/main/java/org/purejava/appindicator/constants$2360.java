...
final class constants$2360 {
    ...
    static final VarHandle const$1 = constants$2360.const$0.varHandle(MemoryLayout.PathElement.groupElement("rise"));
    ...
    static final VarHandle const$3 = constants$2360.const$2.varHandle(MemoryLayout.PathElement.groupElement("refcount"));
    static final VarHandle const$4 = constants$2360.const$2.varHandle(MemoryLayout.PathElement.groupElement("justification"));
    static final VarHandle const$5 = constants$2360.const$2.varHandle(MemoryLayout.PathElement.groupElement("direction"));
}
