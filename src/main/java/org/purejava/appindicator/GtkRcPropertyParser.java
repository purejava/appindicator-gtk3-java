...
public class GtkRcPropertyParser {
    ...
    public interface Function {
        int apply(MemorySegment pspec, MemorySegment rc_string, MemorySegment property_value);
    }
    ...
    private static final MethodHandle UP$MH = app_indicator_h.upcallHandle(GtkRcPropertyParser.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(GtkRcPropertyParser.Function fi, Arena arena) {
