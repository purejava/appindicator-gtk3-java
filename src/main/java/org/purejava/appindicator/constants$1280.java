...
final class constants$1280 {
    ...
    static final VarHandle const$2 = constants$1280.const$0.varHandle(MemoryLayout.PathElement.groupElement("_g_reserved1"));
    static final MethodHandle const$3 = RuntimeHelper.upcallHandle(_GSocketClass._g_reserved2.class, "apply", constants$7.const$5);
    static final VarHandle const$4 = constants$1280.const$0.varHandle(MemoryLayout.PathElement.groupElement("_g_reserved2"));
