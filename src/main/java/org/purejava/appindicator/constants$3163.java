...
final class constants$3163 {
    ...
    static final VarHandle const$2 = constants$3163.const$1.varHandle(MemoryLayout.PathElement.groupElement("priv"));
    static final StructLayout const$3 = MemoryLayout.structLayout(
        ...
        RuntimeHelper.POINTER.withName("orientation_changed"),
        RuntimeHelper.POINTER.withName("style_changed"),
        RuntimeHelper.POINTER.withName("popup_context_menu"),
        RuntimeHelper.POINTER.withName("_gtk_reserved1"),
        RuntimeHelper.POINTER.withName("_gtk_reserved2"),
        RuntimeHelper.POINTER.withName("_gtk_reserved3"),
        RuntimeHelper.POINTER.withName("_gtk_reserved4")
    ).withName("_GtkToolbarClass");
    static final MethodHandle const$4 = RuntimeHelper.upcallHandle(_GtkToolbarClass.orientation_changed.class, "apply", constants$40.const$2);
    static final VarHandle const$5 = constants$3163.const$3.varHandle(MemoryLayout.PathElement.groupElement("orientation_changed"));
}
