...
public class _GtkCheckMenuItemClass {
     ...
     * }
     */
    public final static class toggled {
    ...
    private static final long toggled$OFFSET = $LAYOUT.byteOffset(groupElement("toggled"));
     ...
     * }
     */
    public final static class draw_indicator {

        private draw_indicator() {
            // Should not be called directly
        }
    ...
    private static final long draw_indicator$OFFSET = $LAYOUT.byteOffset(groupElement("draw_indicator"));
