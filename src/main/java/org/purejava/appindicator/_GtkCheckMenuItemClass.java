...
public class _GtkCheckMenuItemClass {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        _GtkMenuItemClass.layout().withName("parent_class"),
        app_indicator_h.C_POINTER.withName("toggled"),
        app_indicator_h.C_POINTER.withName("draw_indicator"),
    ...
    public class toggled {
        ...
        private static final MethodHandle UP$MH = app_indicator_h.upcallHandle(toggled.Function.class, "apply", $DESC);

        /**
         * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
         * The lifetime of the returned segment is managed by {@code arena}
         */
        public static MemorySegment allocate(toggled.Function fi, Arena arena) {
    ...
    private static final AddressLayout toggled$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("toggled"));
     ...
     * }
     */
    public static final AddressLayout toggled$layout() {
        return toggled$LAYOUT;
    }

    private static final long toggled$OFFSET = 1112;
     ...
     * }
     */
    public static final long toggled$offset() {
        return toggled$OFFSET;
    }
     ...
     * }
     */
    public static MemorySegment toggled(MemorySegment struct) {
        return struct.get(toggled$LAYOUT, toggled$OFFSET);
    }
     ...
     * }
     */
    public static void toggled(MemorySegment struct, MemorySegment fieldValue) {
        struct.set(toggled$LAYOUT, toggled$OFFSET, fieldValue);
    }
    ...
    public class draw_indicator {
        ...
        private static final MethodHandle UP$MH = app_indicator_h.upcallHandle(draw_indicator.Function.class, "apply", $DESC);

        /**
         * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
         * The lifetime of the returned segment is managed by {@code arena}
         */
        public static MemorySegment allocate(draw_indicator.Function fi, Arena arena) {
            return Linker.nativeLinker().upcallStub(UP$MH.bindTo(fi), $DESC, arena);
        }
    ...
    private static final AddressLayout draw_indicator$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("draw_indicator"));
     ...
     * }
     */
    public static final AddressLayout draw_indicator$layout() {
        return draw_indicator$LAYOUT;
    }

    private static final long draw_indicator$OFFSET = 1120;
     ...
     * }
     */
    public static final long draw_indicator$offset() {
        return draw_indicator$OFFSET;
    }
     ...
     * }
     */
    public static MemorySegment draw_indicator(MemorySegment struct) {
        return struct.get(draw_indicator$LAYOUT, draw_indicator$OFFSET);
    }
     ...
     * }
     */
    public static void draw_indicator(MemorySegment struct, MemorySegment fieldValue) {
        struct.set(draw_indicator$LAYOUT, draw_indicator$OFFSET, fieldValue);
    }
    ...
    private static final long _gtk_reserved1$OFFSET = 1128;
    ...
    private static final long _gtk_reserved2$OFFSET = 1136;
    ...
    private static final long _gtk_reserved3$OFFSET = 1144;
    ...
    private static final long _gtk_reserved4$OFFSET = 1152;
