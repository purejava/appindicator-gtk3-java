 ...
 *     GType (*get_type_from_name)(GtkBuilder *, const char *);
...
public class _GtkBuilderClass {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        app_indicator_h.C_POINTER.withName("get_type_from_name"),
     ...
     * }
     */
    public class get_type_from_name {
        ...
        private static final MethodHandle UP$MH = app_indicator_h.upcallHandle(get_type_from_name.Function.class, "apply", $DESC);

        /**
         * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
         * The lifetime of the returned segment is managed by {@code arena}
         */
        public static MemorySegment allocate(get_type_from_name.Function fi, Arena arena) {
    ...
    private static final AddressLayout get_type_from_name$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("get_type_from_name"));
     ...
     * }
     */
    public static final AddressLayout get_type_from_name$layout() {
        return get_type_from_name$LAYOUT;
    }

    private static final long get_type_from_name$OFFSET = 136;
     ...
     * }
     */
    public static final long get_type_from_name$offset() {
        return get_type_from_name$OFFSET;
    }
     ...
     * }
     */
    public static MemorySegment get_type_from_name(MemorySegment struct) {
        return struct.get(get_type_from_name$LAYOUT, get_type_from_name$OFFSET);
    }
     ...
     * }
     */
    public static void get_type_from_name(MemorySegment struct, MemorySegment fieldValue) {
        struct.set(get_type_from_name$LAYOUT, get_type_from_name$OFFSET, fieldValue);
    }
    ...
    private static final long _gtk_reserved5$OFFSET = 176;
    ...
    private static final long _gtk_reserved6$OFFSET = 184;
    ...
    private static final long _gtk_reserved7$OFFSET = 192;
    ...
    private static final long _gtk_reserved8$OFFSET = 200;
