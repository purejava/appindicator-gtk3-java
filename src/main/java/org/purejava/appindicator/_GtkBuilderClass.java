...
public class _GtkBuilderClass {
     ...
     * }
     */
    public final static class get_type_from_name {

        private get_type_from_name() {
            // Should not be called directly
        }
    ...
    private static final long get_type_from_name$OFFSET = $LAYOUT.byteOffset(groupElement("get_type_from_name"));
