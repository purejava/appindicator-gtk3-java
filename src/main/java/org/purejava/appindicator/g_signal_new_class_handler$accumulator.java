...
/**
 * {@snippet :
 * int (*g_signal_new_class_handler$accumulator)(struct _GSignalInvocationHint*,struct _GValue*,struct _GValue*,void*);
 * }
 */
public interface g_signal_new_class_handler$accumulator {
    ...
    static MemorySegment allocate(g_signal_new_class_handler$accumulator fi, Arena scope) {
        return RuntimeHelper.upcallStub(constants$604.const$3, fi, constants$34.const$5, scope);
    }
    static g_signal_new_class_handler$accumulator ofAddress(MemorySegment addr, Arena arena) {
