 ...
 * }
 */
public final class GValueTransform {

    private GValueTransform() {
    ...
    private static final MethodHandle UP$MH = app_indicator_h.upcallHandle(GValueTransform.Function.class, "apply", $DESC);
