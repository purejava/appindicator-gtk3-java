 ...
 * void (*got_completion_data)(struct _GFilenameCompleter*);
    ...
    public interface got_completion_data {
        ...
        static MemorySegment allocate(got_completion_data fi, Arena scope) {
            return RuntimeHelper.upcallStub(constants$1092.const$2, fi, constants$13.const$1, scope);
        }
 ...
 * void (*_g_reserved1)();
    ...
    public interface _g_reserved1 {
        ...
        static MemorySegment allocate(_g_reserved1 fi, Arena scope) {
            return RuntimeHelper.upcallStub(constants$1092.const$4, fi, constants$7.const$5, scope);
        }
 ...
 * void (*_g_reserved2)();
    ...
    public interface _g_reserved2 {
        ...
        static MemorySegment allocate(_g_reserved2 fi, Arena scope) {
            return RuntimeHelper.upcallStub(constants$1093.const$0, fi, constants$7.const$5, scope);
        }
 ...
 * void (*_g_reserved3)();
    ...
    public interface _g_reserved3 {
        ...
        static MemorySegment allocate(_g_reserved3 fi, Arena scope) {
            return RuntimeHelper.upcallStub(constants$1093.const$2, fi, constants$7.const$5, scope);
        }
