...
public class _AtkRelationSet {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        app_indicator_h.C_POINTER.withName("relations")
    ...
    private static final AddressLayout relations$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("relations"));
     ...
     * }
     */
    public static final AddressLayout relations$layout() {
        return relations$LAYOUT;
    }

    private static final long relations$OFFSET = $LAYOUT.byteOffset(groupElement("relations"));
     ...
     * }
     */
    public static final long relations$offset() {
     ...
     * }
     */
    public static MemorySegment relations(MemorySegment struct) {
        return struct.get(relations$LAYOUT, relations$OFFSET);
    }
     ...
     * }
     */
    public static void relations(MemorySegment struct, MemorySegment fieldValue) {
        struct.set(relations$LAYOUT, relations$OFFSET, fieldValue);
    }
