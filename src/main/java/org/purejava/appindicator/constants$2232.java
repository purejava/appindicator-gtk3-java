...
final class constants$2232 {
    ...
    static final MethodHandle const$1 = RuntimeHelper.upcallHandle(_GtkMenuShellClass.deactivate.class, "apply", constants$13.const$1);
    static final VarHandle const$2 = constants$2232.const$0.varHandle(MemoryLayout.PathElement.groupElement("deactivate"));
    static final MethodHandle const$3 = RuntimeHelper.upcallHandle(_GtkMenuShellClass.selection_done.class, "apply", constants$13.const$1);
    static final VarHandle const$4 = constants$2232.const$0.varHandle(MemoryLayout.PathElement.groupElement("selection_done"));
    static final MethodHandle const$5 = RuntimeHelper.upcallHandle(_GtkMenuShellClass.move_current.class, "apply", constants$40.const$2);
}
