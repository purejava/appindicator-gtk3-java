...
final class constants$3053 {
    ...
    static final VarHandle const$0 = constants$3052.const$5.varHandle(MemoryLayout.PathElement.groupElement("priv"));
    ...
    static final MethodHandle const$2 = RuntimeHelper.upcallHandle(_GtkScaleButtonClass.value_changed.class, "apply", constants$689.const$5);
    static final VarHandle const$3 = constants$3053.const$1.varHandle(MemoryLayout.PathElement.groupElement("value_changed"));
    static final MethodHandle const$4 = RuntimeHelper.upcallHandle(_GtkScaleButtonClass._gtk_reserved1.class, "apply", constants$7.const$5);
    static final VarHandle const$5 = constants$3053.const$1.varHandle(MemoryLayout.PathElement.groupElement("_gtk_reserved1"));
}
