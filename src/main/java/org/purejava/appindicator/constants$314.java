...
final class constants$314 {
    ...
    static final VarHandle const$1 = constants$314.const$0.varHandle(MemoryLayout.PathElement.groupElement("ref_count"));
    static final VarHandle const$2 = constants$314.const$0.varHandle(MemoryLayout.PathElement.groupElement("funcs"));
    static final VarHandle const$3 = constants$314.const$0.varHandle(MemoryLayout.PathElement.groupElement("encoding"));
    static final VarHandle const$4 = constants$314.const$0.varHandle(MemoryLayout.PathElement.groupElement("read_cd"));
    static final VarHandle const$5 = constants$314.const$0.varHandle(MemoryLayout.PathElement.groupElement("write_cd"));
}
