...
public class GTestLogBuffer {
    ...
    private static final AddressLayout msgs$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("msgs"));
     ...
     * }
     */
    public static final AddressLayout msgs$layout() {
        return msgs$LAYOUT;
    }
    ...
    public static MemorySegment msgs(MemorySegment struct) {
        return struct.get(msgs$LAYOUT, msgs$OFFSET);
    }
    ...
    public static void msgs(MemorySegment struct, MemorySegment fieldValue) {
        struct.set(msgs$LAYOUT, msgs$OFFSET, fieldValue);
    }
