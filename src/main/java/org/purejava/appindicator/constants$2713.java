...
final class constants$2713 {
    ...
    static final MethodHandle const$2 = RuntimeHelper.upcallHandle(_GtkFlowBoxChildClass.activate.class, "apply", constants$13.const$1);
    static final VarHandle const$3 = constants$2713.const$1.varHandle(MemoryLayout.PathElement.groupElement("activate"));
    static final MethodHandle const$4 = RuntimeHelper.upcallHandle(_GtkFlowBoxChildClass._gtk_reserved1.class, "apply", constants$7.const$5);
    static final VarHandle const$5 = constants$2713.const$1.varHandle(MemoryLayout.PathElement.groupElement("_gtk_reserved1"));
}
