...
public class _GtkDialog {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        _GtkWindow.layout().withName("window"),
    ...
    public static MemorySegment window(MemorySegment struct) {
        return struct.asSlice(window$OFFSET, window$LAYOUT.byteSize());
    }
    ...
    public static void window(MemorySegment struct, MemorySegment fieldValue) {
        MemorySegment.copy(fieldValue, 0L, struct, window$OFFSET, window$LAYOUT.byteSize());
    }
