...
final class constants$2908 {
    ...
    static final StructLayout const$3 = MemoryLayout.structLayout(
        ...
        RuntimeHelper.POINTER.withName("priv")
    ).withName("_GtkNotebook");
    static final VarHandle const$4 = constants$2908.const$3.varHandle(MemoryLayout.PathElement.groupElement("priv"));
    static final StructLayout const$5 = MemoryLayout.structLayout(
        ...
        RuntimeHelper.POINTER.withName("switch_page"),
        RuntimeHelper.POINTER.withName("select_page"),
        RuntimeHelper.POINTER.withName("focus_tab"),
        RuntimeHelper.POINTER.withName("change_current_page"),
        RuntimeHelper.POINTER.withName("move_focus_out"),
        RuntimeHelper.POINTER.withName("reorder_tab"),
        RuntimeHelper.POINTER.withName("insert_page"),
        RuntimeHelper.POINTER.withName("create_window"),
        RuntimeHelper.POINTER.withName("page_reordered"),
        RuntimeHelper.POINTER.withName("page_removed"),
        RuntimeHelper.POINTER.withName("page_added"),
        RuntimeHelper.POINTER.withName("_gtk_reserved1"),
        RuntimeHelper.POINTER.withName("_gtk_reserved2"),
        RuntimeHelper.POINTER.withName("_gtk_reserved3"),
        RuntimeHelper.POINTER.withName("_gtk_reserved4"),
