...
public class _GtkAppChooserButtonClass {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        _GtkComboBoxClass.layout().withName("parent_class"),
        app_indicator_h.C_POINTER.withName("custom_item_activated"),
     ...
     * }
     */
    public final static class custom_item_activated {

        private custom_item_activated() {
            // Should not be called directly
        }
        ...
        private static final MethodHandle UP$MH = app_indicator_h.upcallHandle(custom_item_activated.Function.class, "apply", $DESC);

        /**
         * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
         * The lifetime of the returned segment is managed by {@code arena}
         */
        public static MemorySegment allocate(custom_item_activated.Function fi, Arena arena) {
    ...
    private static final AddressLayout custom_item_activated$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("custom_item_activated"));
     ...
     * }
     */
    public static final AddressLayout custom_item_activated$layout() {
        return custom_item_activated$LAYOUT;
    }

    private static final long custom_item_activated$OFFSET = $LAYOUT.byteOffset(groupElement("custom_item_activated"));
     ...
     * }
     */
    public static final long custom_item_activated$offset() {
        return custom_item_activated$OFFSET;
    }
     ...
     * }
     */
    public static MemorySegment custom_item_activated(MemorySegment struct) {
        return struct.get(custom_item_activated$LAYOUT, custom_item_activated$OFFSET);
    }
     ...
     * }
     */
    public static void custom_item_activated(MemorySegment struct, MemorySegment fieldValue) {
        struct.set(custom_item_activated$LAYOUT, custom_item_activated$OFFSET, fieldValue);
    }
