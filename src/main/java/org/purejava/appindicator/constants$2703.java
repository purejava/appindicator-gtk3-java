...
final class constants$2703 {
    ...
    static final StructLayout const$3 = MemoryLayout.structLayout(
        ...
        RuntimeHelper.POINTER.withName("child_activated"),
        RuntimeHelper.POINTER.withName("selected_children_changed"),
        RuntimeHelper.POINTER.withName("activate_cursor_child"),
        RuntimeHelper.POINTER.withName("toggle_cursor_child"),
    ...
    static final MethodHandle const$4 = RuntimeHelper.upcallHandle(_GtkFlowBoxClass.child_activated.class, "apply", constants$13.const$4);
    static final VarHandle const$5 = constants$2703.const$3.varHandle(MemoryLayout.PathElement.groupElement("child_activated"));
}
