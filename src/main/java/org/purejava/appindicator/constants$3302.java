...
final class constants$3302 {
    ...
    static final VarHandle const$2 = constants$3302.const$1.varHandle(MemoryLayout.PathElement.groupElement("priv"));
    ...
    static final MethodHandle const$4 = RuntimeHelper.upcallHandle(_GtkHSVClass.changed.class, "apply", constants$13.const$1);
    static final VarHandle const$5 = constants$3302.const$3.varHandle(MemoryLayout.PathElement.groupElement("changed"));
}
