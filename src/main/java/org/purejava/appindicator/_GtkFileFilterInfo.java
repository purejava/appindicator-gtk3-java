...
public class _GtkFileFilterInfo {
    ...
    public static int contains$get(MemorySegment seg) {
        return (int)constants$2680.const$3.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void contains$set(MemorySegment seg, int x) {
        constants$2680.const$3.set(seg, x);
    }
    public static int contains$get(MemorySegment seg, long index) {
        return (int)constants$2680.const$3.get(seg.asSlice(index*sizeof()));
    }
    public static void contains$set(MemorySegment seg, long index, int x) {
        constants$2680.const$3.set(seg.asSlice(index*sizeof()), x);
    }
    ...
    public static MemorySegment filename$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)constants$2680.const$4.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment filename$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)constants$2680.const$4.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemorySegment uri$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)constants$2680.const$5.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment uri$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)constants$2680.const$5.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemorySegment display_name$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)constants$2681.const$0.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment display_name$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)constants$2681.const$0.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemorySegment mime_type$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)constants$2681.const$1.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void mime_type$set(MemorySegment seg, MemorySegment x) {
        constants$2681.const$1.set(seg, x);
    }
    public static MemorySegment mime_type$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)constants$2681.const$1.get(seg.asSlice(index*sizeof()));
    }
    public static void mime_type$set(MemorySegment seg, long index, MemorySegment x) {
        constants$2681.const$1.set(seg.asSlice(index*sizeof()), x);
    }
