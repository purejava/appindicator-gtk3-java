...
/**
 * {@snippet lang=c :
 * typedef gchar *(*GTypeValueLCopyFunc)(const GValue *, guint, GTypeCValue *, guint)
 * }
 */
public final class GTypeValueLCopyFunc {

    private GTypeValueLCopyFunc() {
    ...
    private static final MethodHandle UP$MH = app_indicator_h.upcallHandle(GTypeValueLCopyFunc.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(GTypeValueLCopyFunc.Function fi, Arena arena) {
