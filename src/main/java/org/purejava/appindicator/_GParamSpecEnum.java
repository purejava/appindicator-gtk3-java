...
public class _GParamSpecEnum {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        app_indicator_h.C_POINTER.withName("enum_class"),
        app_indicator_h.C_INT.withName("default_value"),
    ...
    private static final long enum_class$OFFSET = $LAYOUT.byteOffset(groupElement("enum_class"));
