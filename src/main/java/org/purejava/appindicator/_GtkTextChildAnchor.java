...
public class _GtkTextChildAnchor {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        app_indicator_h.C_POINTER.withName("segment")
    ...
    private static final AddressLayout segment$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("segment"));
     ...
     * }
     */
    public static final AddressLayout segment$layout() {
        return segment$LAYOUT;
    }

    private static final long segment$OFFSET = 24;
