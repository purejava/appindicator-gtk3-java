...
public class _GtkToggleActionEntry {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        app_indicator_h.C_INT.withName("is_active"),
    ...
    private static final OfInt is_active$LAYOUT = (OfInt)$LAYOUT.select(groupElement("is_active"));
     ...
     * }
     */
    public static final OfInt is_active$layout() {
     ...
     * }
     */
    public static int is_active(MemorySegment struct) {
     ...
     * }
     */
    public static void is_active(MemorySegment struct, int fieldValue) {
