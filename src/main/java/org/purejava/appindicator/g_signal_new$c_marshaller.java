...
/**
 * {@snippet :
 * void (*g_signal_new$c_marshaller)(struct _GClosure*,struct _GValue*,unsigned int,struct _GValue*,void*,void*);
 * }
 */
public interface g_signal_new$c_marshaller {
    ...
    static MemorySegment allocate(g_signal_new$c_marshaller fi, Arena scope) {
        return RuntimeHelper.upcallStub(constants$603.const$5, fi, constants$584.const$3, scope);
    }
    static g_signal_new$c_marshaller ofAddress(MemorySegment addr, Arena arena) {
