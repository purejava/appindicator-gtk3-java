...
public class _GtkRcStyleClass {
     ...
     * }
     */
    public final static class create_rc_style {

        private create_rc_style() {
            // Should not be called directly
        }
    ...
    private static final long create_rc_style$OFFSET = $LAYOUT.byteOffset(groupElement("create_rc_style"));
     ...
     * }
     */
    public final static class create_style {
    ...
    private static final long create_style$OFFSET = $LAYOUT.byteOffset(groupElement("create_style"));
