...
public class tm {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        app_indicator_h.C_INT.withName("tm_sec"),
        app_indicator_h.C_INT.withName("tm_min"),
        app_indicator_h.C_INT.withName("tm_hour"),
        app_indicator_h.C_INT.withName("tm_mday"),
        app_indicator_h.C_INT.withName("tm_mon"),
        app_indicator_h.C_INT.withName("tm_year"),
        app_indicator_h.C_INT.withName("tm_wday"),
        app_indicator_h.C_INT.withName("tm_yday"),
        app_indicator_h.C_INT.withName("tm_isdst"),
        MemoryLayout.paddingLayout(4),
        app_indicator_h.C_LONG.withName("tm_gmtoff"),
        app_indicator_h.C_POINTER.withName("tm_zone")
    ).withName("tm");
