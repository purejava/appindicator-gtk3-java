...
public class GDatagramBasedSourceFunc {
    ...
    public interface Function {
        int apply(MemorySegment datagram_based, int condition, MemorySegment data);
    }
    ...
    private static final MethodHandle UP$MH = app_indicator_h.upcallHandle(GDatagramBasedSourceFunc.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(GDatagramBasedSourceFunc.Function fi, Arena arena) {
