...
final class constants$3077 {
    ...
    static final StructLayout const$3 = MemoryLayout.structLayout(
        ...
        RuntimeHelper.POINTER.withName("search_changed"),
        RuntimeHelper.POINTER.withName("next_match"),
        RuntimeHelper.POINTER.withName("previous_match"),
        RuntimeHelper.POINTER.withName("stop_search")
    ).withName("_GtkSearchEntryClass");
    static final MethodHandle const$4 = RuntimeHelper.upcallHandle(_GtkSearchEntryClass.search_changed.class, "apply", constants$13.const$1);
    static final VarHandle const$5 = constants$3077.const$3.varHandle(MemoryLayout.PathElement.groupElement("search_changed"));
}
