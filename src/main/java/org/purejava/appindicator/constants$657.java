...
final class constants$657 {
    ...
    static final VarHandle const$2 = constants$657.const$1.varHandle(MemoryLayout.PathElement.groupElement("minimum"));
    static final VarHandle const$3 = constants$657.const$1.varHandle(MemoryLayout.PathElement.groupElement("maximum"));
    static final VarHandle const$4 = constants$657.const$1.varHandle(MemoryLayout.PathElement.groupElement("default_value"));
