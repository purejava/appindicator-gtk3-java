...
final class constants$2101 {
    ...
    static final VarHandle const$1 = constants$2101.const$0.varHandle(MemoryLayout.PathElement.groupElement("activate_signal"));
    static final MethodHandle const$2 = RuntimeHelper.upcallHandle(_GtkWidgetClass.dispatch_child_properties_changed.class, "apply", constants$42.const$4);
    static final VarHandle const$3 = constants$2101.const$0.varHandle(MemoryLayout.PathElement.groupElement("dispatch_child_properties_changed"));
    static final MethodHandle const$4 = RuntimeHelper.upcallHandle(_GtkWidgetClass.destroy.class, "apply", constants$13.const$1);
    static final VarHandle const$5 = constants$2101.const$0.varHandle(MemoryLayout.PathElement.groupElement("destroy"));
}
