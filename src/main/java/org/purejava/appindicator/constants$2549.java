...
final class constants$2549 {
    ...
    static final VarHandle const$1 = constants$2549.const$0.varHandle(MemoryLayout.PathElement.groupElement("priv"));
    ...
    static final MethodHandle const$3 = RuntimeHelper.upcallHandle(_GtkButtonClass.pressed.class, "apply", constants$13.const$1);
    static final VarHandle const$4 = constants$2549.const$2.varHandle(MemoryLayout.PathElement.groupElement("pressed"));
    static final MethodHandle const$5 = RuntimeHelper.upcallHandle(_GtkButtonClass.released.class, "apply", constants$13.const$1);
}
