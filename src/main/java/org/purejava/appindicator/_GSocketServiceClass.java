...
public class _GSocketServiceClass {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        _GSocketListenerClass.layout().withName("parent_class"),
        app_indicator_h.C_POINTER.withName("incoming"),
    ...
    public class incoming {
        ...
        private static final MethodHandle UP$MH = app_indicator_h.upcallHandle(incoming.Function.class, "apply", $DESC);

        /**
         * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
         * The lifetime of the returned segment is managed by {@code arena}
         */
        public static MemorySegment allocate(incoming.Function fi, Arena arena) {
    ...
    private static final AddressLayout incoming$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("incoming"));
     ...
     * }
     */
    public static final AddressLayout incoming$layout() {
        return incoming$LAYOUT;
    }

    private static final long incoming$OFFSET = 192;
     ...
     * }
     */
    public static final long incoming$offset() {
     ...
     * }
     */
    public static MemorySegment incoming(MemorySegment struct) {
        return struct.get(incoming$LAYOUT, incoming$OFFSET);
    }
     ...
     * }
     */
    public static void incoming(MemorySegment struct, MemorySegment fieldValue) {
        struct.set(incoming$LAYOUT, incoming$OFFSET, fieldValue);
    }
    ...
    private static final long _g_reserved1$OFFSET = 200;
    ...
    private static final long _g_reserved2$OFFSET = 208;
    ...
    private static final long _g_reserved3$OFFSET = 216;
    ...
    private static final long _g_reserved4$OFFSET = 224;
    ...
    private static final long _g_reserved5$OFFSET = 232;
    ...
    private static final long _g_reserved6$OFFSET = 240;
