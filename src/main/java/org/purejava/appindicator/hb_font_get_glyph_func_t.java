...
public interface hb_font_get_glyph_func_t {
    ...
    static MemorySegment allocate(hb_font_get_glyph_func_t fi, Arena scope) {
        return RuntimeHelper.upcallStub(constants$1518.const$1, fi, constants$1029.const$4, scope);
    }
    static hb_font_get_glyph_func_t ofAddress(MemorySegment addr, Arena arena) {
