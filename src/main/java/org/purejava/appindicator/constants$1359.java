...
final class constants$1359 {
    ...
    static final VarHandle const$1 = constants$1359.const$0.varHandle(MemoryLayout.PathElement.groupElement("priv"));
    ...
    static final MethodHandle const$3 = RuntimeHelper.upcallHandle(_GTlsConnectionClass.accept_certificate.class, "apply", constants$62.const$0);
    static final VarHandle const$4 = constants$1359.const$2.varHandle(MemoryLayout.PathElement.groupElement("accept_certificate"));
    static final MethodHandle const$5 = RuntimeHelper.upcallHandle(_GTlsConnectionClass.handshake.class, "apply", constants$12.const$2);
}
