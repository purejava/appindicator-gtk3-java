...
public interface GOptionParseFunc {
    ...
    static MemorySegment allocate(GOptionParseFunc fi, Arena scope) {
        return RuntimeHelper.upcallStub(constants$382.const$1, fi, constants$34.const$5, scope);
    }
    static GOptionParseFunc ofAddress(MemorySegment addr, Arena arena) {
