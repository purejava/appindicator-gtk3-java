...
public class GOptionParseFunc {
    ...
    public interface Function {
        int apply(MemorySegment context, MemorySegment group, MemorySegment data, MemorySegment error);
    }
    ...
    private static final MethodHandle UP$MH = app_indicator_h.upcallHandle(GOptionParseFunc.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(GOptionParseFunc.Function fi, Arena arena) {
