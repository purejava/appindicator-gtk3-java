...
final class constants$3330 {
    ...
    static final VarHandle const$1 = constants$3330.const$0.varHandle(MemoryLayout.PathElement.groupElement("type_name"));
    static final VarHandle const$2 = constants$3330.const$0.varHandle(MemoryLayout.PathElement.groupElement("property_name"));
    static final VarHandle const$3 = constants$3330.const$0.varHandle(MemoryLayout.PathElement.groupElement("origin"));
