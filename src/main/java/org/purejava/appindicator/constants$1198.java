...
final class constants$1198 {
    ...
    static final MethodHandle const$3 = RuntimeHelper.upcallHandle(_GNativeVolumeMonitorClass.get_mount_for_mount_path.class, "apply", constants$5.const$5);
    static final VarHandle const$4 = constants$1198.const$2.varHandle(MemoryLayout.PathElement.groupElement("get_mount_for_mount_path"));
