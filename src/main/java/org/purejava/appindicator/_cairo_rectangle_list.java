...
public class _cairo_rectangle_list {
    ...
    private static final long rectangles$OFFSET = $LAYOUT.byteOffset(groupElement("rectangles"));
    ...
    private static final long num_rectangles$OFFSET = $LAYOUT.byteOffset(groupElement("num_rectangles"));
