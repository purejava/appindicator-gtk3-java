 ...
 * }
 */
public final class GObjectGetPropertyFunc {

    private GObjectGetPropertyFunc() {
    ...
    private static final MethodHandle UP$MH = app_indicator_h.upcallHandle(GObjectGetPropertyFunc.Function.class, "apply", $DESC);
