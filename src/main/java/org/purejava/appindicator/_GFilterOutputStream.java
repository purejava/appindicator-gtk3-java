...
public class _GFilterOutputStream {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        _GOutputStream.layout().withName("parent_instance"),
        app_indicator_h.C_POINTER.withName("base_stream")
    ...
    private static final AddressLayout base_stream$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("base_stream"));
     ...
     * }
     */
    public static final AddressLayout base_stream$layout() {
     ...
     * }
     */
    public static final long base_stream$offset() {
        return base_stream$OFFSET;
    }
     ...
     * }
     */
    public static MemorySegment base_stream(MemorySegment struct) {
        return struct.get(base_stream$LAYOUT, base_stream$OFFSET);
    }
     ...
     * }
     */
    public static void base_stream(MemorySegment struct, MemorySegment fieldValue) {
        struct.set(base_stream$LAYOUT, base_stream$OFFSET, fieldValue);
    }
