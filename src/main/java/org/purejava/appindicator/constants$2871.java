...
final class constants$2871 {
    ...
    static final StructLayout const$0 = MemoryLayout.structLayout(
        MemoryLayout.structLayout(
            ...
            MemoryLayout.paddingLayout(8),
            RuntimeHelper.POINTER.withName("deactivate"),
            RuntimeHelper.POINTER.withName("selection_done"),
            RuntimeHelper.POINTER.withName("move_current"),
            RuntimeHelper.POINTER.withName("activate_current"),
            RuntimeHelper.POINTER.withName("cancel"),
            RuntimeHelper.POINTER.withName("select_item"),
            RuntimeHelper.POINTER.withName("insert"),
            RuntimeHelper.POINTER.withName("get_popup_delay"),
            RuntimeHelper.POINTER.withName("move_selected"),
            RuntimeHelper.POINTER.withName("_gtk_reserved1"),
            RuntimeHelper.POINTER.withName("_gtk_reserved2"),
            RuntimeHelper.POINTER.withName("_gtk_reserved3"),
            RuntimeHelper.POINTER.withName("_gtk_reserved4")
    ...
    static final MethodHandle const$1 = RuntimeHelper.upcallHandle(_GtkMenuBarClass._gtk_reserved1.class, "apply", constants$7.const$5);
    static final VarHandle const$2 = constants$2871.const$0.varHandle(MemoryLayout.PathElement.groupElement("_gtk_reserved1"));
    static final MethodHandle const$3 = RuntimeHelper.upcallHandle(_GtkMenuBarClass._gtk_reserved2.class, "apply", constants$7.const$5);
    static final VarHandle const$4 = constants$2871.const$0.varHandle(MemoryLayout.PathElement.groupElement("_gtk_reserved2"));
    static final MethodHandle const$5 = RuntimeHelper.upcallHandle(_GtkMenuBarClass._gtk_reserved3.class, "apply", constants$7.const$5);
}
