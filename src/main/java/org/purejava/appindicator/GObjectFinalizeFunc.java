 ...
 * }
 */
public final class GObjectFinalizeFunc {

    private GObjectFinalizeFunc() {
    ...
    private static final MethodHandle UP$MH = app_indicator_h.upcallHandle(GObjectFinalizeFunc.Function.class, "apply", $DESC);
