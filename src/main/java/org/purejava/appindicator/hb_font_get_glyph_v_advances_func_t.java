...
public interface hb_font_get_glyph_v_advances_func_t {
    ...
    static MemorySegment allocate(hb_font_get_glyph_v_advances_func_t fi, Arena scope) {
        return RuntimeHelper.upcallStub(constants$1478.const$5, fi, constants$1478.const$1, scope);
    }
    static hb_font_get_glyph_v_advances_func_t ofAddress(MemorySegment addr, Arena arena) {
