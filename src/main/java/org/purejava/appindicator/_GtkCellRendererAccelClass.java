...
public class _GtkCellRendererAccelClass {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        _GtkCellRendererTextClass.layout().withName("parent_class"),
        app_indicator_h.C_POINTER.withName("accel_edited"),
        app_indicator_h.C_POINTER.withName("accel_cleared"),
    ...
    public class accel_edited {
        ...
        private static final MethodHandle UP$MH = app_indicator_h.upcallHandle(accel_edited.Function.class, "apply", $DESC);

        /**
         * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
         * The lifetime of the returned segment is managed by {@code arena}
         */
        public static MemorySegment allocate(accel_edited.Function fi, Arena arena) {
    ...
    private static final AddressLayout accel_edited$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("accel_edited"));
     ...
     * }
     */
    public static final AddressLayout accel_edited$layout() {
        return accel_edited$LAYOUT;
    }

    private static final long accel_edited$OFFSET = 304;
     ...
     * }
     */
    public static final long accel_edited$offset() {
        return accel_edited$OFFSET;
    }
     ...
     * }
     */
    public static MemorySegment accel_edited(MemorySegment struct) {
        return struct.get(accel_edited$LAYOUT, accel_edited$OFFSET);
    }
     ...
     * }
     */
    public static void accel_edited(MemorySegment struct, MemorySegment fieldValue) {
        struct.set(accel_edited$LAYOUT, accel_edited$OFFSET, fieldValue);
    }
    ...
    public class accel_cleared {
        ...
        private static final MethodHandle UP$MH = app_indicator_h.upcallHandle(accel_cleared.Function.class, "apply", $DESC);

        /**
         * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
         * The lifetime of the returned segment is managed by {@code arena}
         */
        public static MemorySegment allocate(accel_cleared.Function fi, Arena arena) {
            return Linker.nativeLinker().upcallStub(UP$MH.bindTo(fi), $DESC, arena);
        }
    ...
    private static final AddressLayout accel_cleared$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("accel_cleared"));
     ...
     * }
     */
    public static final AddressLayout accel_cleared$layout() {
        return accel_cleared$LAYOUT;
    }

    private static final long accel_cleared$OFFSET = 312;
     ...
     * }
     */
    public static final long accel_cleared$offset() {
        return accel_cleared$OFFSET;
    }
     ...
     * }
     */
    public static MemorySegment accel_cleared(MemorySegment struct) {
        return struct.get(accel_cleared$LAYOUT, accel_cleared$OFFSET);
    }
     ...
     * }
     */
    public static void accel_cleared(MemorySegment struct, MemorySegment fieldValue) {
        struct.set(accel_cleared$LAYOUT, accel_cleared$OFFSET, fieldValue);
    }
    ...
    private static final long _gtk_reserved0$OFFSET = 320;
    ...
    private static final long _gtk_reserved1$OFFSET = 328;
    ...
    private static final long _gtk_reserved2$OFFSET = 336;
    ...
    private static final long _gtk_reserved3$OFFSET = 344;
    ...
    private static final long _gtk_reserved4$OFFSET = 352;
