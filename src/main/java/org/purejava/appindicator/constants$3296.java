...
final class constants$3296 {
    ...
    static final StructLayout const$1 = MemoryLayout.structLayout(
        ...
        RuntimeHelper.POINTER.withName("priv")
    ).withName("_GtkHandleBox");
    static final VarHandle const$2 = constants$3296.const$1.varHandle(MemoryLayout.PathElement.groupElement("priv"));
    static final StructLayout const$3 = MemoryLayout.structLayout(
        ...
        RuntimeHelper.POINTER.withName("child_attached"),
        RuntimeHelper.POINTER.withName("child_detached"),
        RuntimeHelper.POINTER.withName("_gtk_reserved1"),
        RuntimeHelper.POINTER.withName("_gtk_reserved2"),
        RuntimeHelper.POINTER.withName("_gtk_reserved3"),
        RuntimeHelper.POINTER.withName("_gtk_reserved4")
    ).withName("_GtkHandleBoxClass");
    static final MethodHandle const$4 = RuntimeHelper.upcallHandle(_GtkHandleBoxClass.child_attached.class, "apply", constants$13.const$4);
    static final VarHandle const$5 = constants$3296.const$3.varHandle(MemoryLayout.PathElement.groupElement("child_attached"));
}
