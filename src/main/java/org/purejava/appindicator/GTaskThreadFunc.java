...
public class GTaskThreadFunc {
    ...
    public interface Function {
        void apply(MemorySegment task, MemorySegment source_object, MemorySegment task_data, MemorySegment cancellable);
    }
    ...
    private static final MethodHandle UP$MH = app_indicator_h.upcallHandle(GTaskThreadFunc.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(GTaskThreadFunc.Function fi, Arena arena) {
