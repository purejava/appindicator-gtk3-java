...
final class constants$1772 {
    ...
    static final VarHandle const$2 = constants$1772.const$1.varHandle(MemoryLayout.PathElement.groupElement("type"));
    static final VarHandle const$3 = constants$1772.const$1.varHandle(MemoryLayout.PathElement.groupElement("window"));
    static final VarHandle const$4 = constants$1772.const$1.varHandle(MemoryLayout.PathElement.groupElement("send_event"));
