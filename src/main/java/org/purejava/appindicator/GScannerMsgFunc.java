...
public interface GScannerMsgFunc {
    ...
    static MemorySegment allocate(GScannerMsgFunc fi, Arena scope) {
        return RuntimeHelper.upcallStub(constants$420.const$1, fi, constants$164.const$5, scope);
    }
    static GScannerMsgFunc ofAddress(MemorySegment addr, Arena arena) {
