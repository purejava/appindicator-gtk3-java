...
final class constants$2495 {
    ...
    static final VarHandle const$0 = constants$2494.const$5.varHandle(MemoryLayout.PathElement.groupElement("priv"));
    ...
    static final MethodHandle const$2 = RuntimeHelper.upcallHandle(_GtkComboBoxClass.changed.class, "apply", constants$13.const$1);
    static final VarHandle const$3 = constants$2495.const$1.varHandle(MemoryLayout.PathElement.groupElement("changed"));
    static final MethodHandle const$4 = RuntimeHelper.upcallHandle(_GtkComboBoxClass.format_entry_text.class, "apply", constants$5.const$5);
    static final VarHandle const$5 = constants$2495.const$1.varHandle(MemoryLayout.PathElement.groupElement("format_entry_text"));
}
