...
public class _GdkEventScroll {
    ...
    private static final long delta_x$OFFSET = $LAYOUT.byteOffset(groupElement("delta_x"));
    ...
    private static final long delta_y$OFFSET = $LAYOUT.byteOffset(groupElement("delta_y"));
