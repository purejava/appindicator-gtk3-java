...
public class _GdkEventMotion {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        app_indicator_h.C_SHORT.withName("is_hint"),
    ...
    private static final OfShort is_hint$LAYOUT = (OfShort)$LAYOUT.select(groupElement("is_hint"));
     ...
     * }
     */
    public static final OfShort is_hint$layout() {
        return is_hint$LAYOUT;
    }

    private static final long is_hint$OFFSET = $LAYOUT.byteOffset(groupElement("is_hint"));
     ...
     * }
     */
    public static short is_hint(MemorySegment struct) {
     ...
     * }
     */
    public static void is_hint(MemorySegment struct, short fieldValue) {
