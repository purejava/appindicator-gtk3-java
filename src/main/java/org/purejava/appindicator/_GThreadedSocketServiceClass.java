 ...
 * int (*run)(struct _GThreadedSocketService*,struct _GSocketConnection*,struct _GObject*);
    ...
    public interface run {
        ...
        static MemorySegment allocate(run fi, Arena scope) {
            return RuntimeHelper.upcallStub(constants$1343.const$2, fi, constants$12.const$2, scope);
        }
    ...
    public static MemorySegment run$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)constants$1343.const$3.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment run$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)constants$1343.const$3.get(seg.asSlice(index*sizeof()));
    }
 ...
 * void (*_g_reserved1)();
    ...
    public interface _g_reserved1 {
        ...
        static MemorySegment allocate(_g_reserved1 fi, Arena scope) {
            return RuntimeHelper.upcallStub(constants$1343.const$4, fi, constants$7.const$5, scope);
        }
    ...
    public static MemorySegment _g_reserved1$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)constants$1343.const$5.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment _g_reserved1$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)constants$1343.const$5.get(seg.asSlice(index*sizeof()));
    }
 ...
 * void (*_g_reserved2)();
    ...
    public interface _g_reserved2 {
        ...
        static MemorySegment allocate(_g_reserved2 fi, Arena scope) {
            return RuntimeHelper.upcallStub(constants$1344.const$0, fi, constants$7.const$5, scope);
        }
    ...
    public static MemorySegment _g_reserved2$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)constants$1344.const$1.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment _g_reserved2$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)constants$1344.const$1.get(seg.asSlice(index*sizeof()));
    }
 ...
 * void (*_g_reserved3)();
    ...
    public interface _g_reserved3 {
        ...
        static MemorySegment allocate(_g_reserved3 fi, Arena scope) {
            return RuntimeHelper.upcallStub(constants$1344.const$2, fi, constants$7.const$5, scope);
        }
    ...
    public static MemorySegment _g_reserved3$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)constants$1344.const$3.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment _g_reserved3$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)constants$1344.const$3.get(seg.asSlice(index*sizeof()));
    }
 ...
 * void (*_g_reserved4)();
    ...
    public interface _g_reserved4 {
        ...
        static MemorySegment allocate(_g_reserved4 fi, Arena scope) {
            return RuntimeHelper.upcallStub(constants$1344.const$4, fi, constants$7.const$5, scope);
        }
    ...
    public static MemorySegment _g_reserved4$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)constants$1344.const$5.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void _g_reserved4$set(MemorySegment seg, MemorySegment x) {
        constants$1344.const$5.set(seg, x);
    }
    public static MemorySegment _g_reserved4$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)constants$1344.const$5.get(seg.asSlice(index*sizeof()));
    }
    public static void _g_reserved4$set(MemorySegment seg, long index, MemorySegment x) {
        constants$1344.const$5.set(seg.asSlice(index*sizeof()), x);
    }
 ...
 * void (*_g_reserved5)();
    ...
    public interface _g_reserved5 {
        ...
        static MemorySegment allocate(_g_reserved5 fi, Arena scope) {
            return RuntimeHelper.upcallStub(constants$1345.const$0, fi, constants$7.const$5, scope);
        }
    ...
    public static MemorySegment _g_reserved5$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)constants$1345.const$1.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment _g_reserved5$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)constants$1345.const$1.get(seg.asSlice(index*sizeof()));
    }
