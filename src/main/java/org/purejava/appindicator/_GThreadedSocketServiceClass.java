 ...
 *     struct _GSocketServiceClass parent_class;
 *     int (*run)(struct _GThreadedSocketService*,struct _GSocketConnection*,struct _GObject*);
 *     void (*_g_reserved1)();
 *     void (*_g_reserved2)();
 *     void (*_g_reserved3)();
 *     void (*_g_reserved4)();
 ...
 * int (*run)(struct _GThreadedSocketService*,struct _GSocketConnection*,struct _GObject*);
    ...
    public interface run {
        ...
        static MemorySegment allocate(run fi, Arena scope) {
            return RuntimeHelper.upcallStub(constants$1347.const$3, fi, constants$12.const$2, scope);
        }
 ...
 * void (*_g_reserved1)();
    ...
    public interface _g_reserved1 {
        ...
        static MemorySegment allocate(_g_reserved1 fi, Arena scope) {
            return RuntimeHelper.upcallStub(constants$1347.const$5, fi, constants$7.const$5, scope);
        }
 ...
 * void (*_g_reserved2)();
    ...
    public interface _g_reserved2 {
        ...
        static MemorySegment allocate(_g_reserved2 fi, Arena scope) {
            return RuntimeHelper.upcallStub(constants$1348.const$1, fi, constants$7.const$5, scope);
        }
 ...
 * void (*_g_reserved3)();
    ...
    public interface _g_reserved3 {
        ...
        static MemorySegment allocate(_g_reserved3 fi, Arena scope) {
            return RuntimeHelper.upcallStub(constants$1348.const$3, fi, constants$7.const$5, scope);
        }
 ...
 * void (*_g_reserved4)();
    ...
    public interface _g_reserved4 {
        ...
        static MemorySegment allocate(_g_reserved4 fi, Arena scope) {
            return RuntimeHelper.upcallStub(constants$1348.const$5, fi, constants$7.const$5, scope);
        }
 ...
 * void (*_g_reserved5)();
    ...
    public interface _g_reserved5 {
        ...
        static MemorySegment allocate(_g_reserved5 fi, Arena scope) {
            return RuntimeHelper.upcallStub(constants$1349.const$1, fi, constants$7.const$5, scope);
        }
    ...
    public static MemorySegment _g_reserved5$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)constants$1349.const$2.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void _g_reserved5$set(MemorySegment seg, MemorySegment x) {
        constants$1349.const$2.set(seg, x);
    }
    public static MemorySegment _g_reserved5$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)constants$1349.const$2.get(seg.asSlice(index*sizeof()));
    }
    public static void _g_reserved5$set(MemorySegment seg, long index, MemorySegment x) {
        constants$1349.const$2.set(seg.asSlice(index*sizeof()), x);
    }
