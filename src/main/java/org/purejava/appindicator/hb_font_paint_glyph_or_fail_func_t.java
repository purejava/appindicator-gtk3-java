...
/**
 * {@snippet lang=c :
 * typedef hb_bool_t (*hb_font_paint_glyph_or_fail_func_t)(hb_font_t *, void *, hb_codepoint_t, hb_paint_funcs_t *, void *, unsigned int, hb_color_t, void *)
 * }
 */
public final class hb_font_paint_glyph_or_fail_func_t {

    private hb_font_paint_glyph_or_fail_func_t() {
    ...
    private static final MethodHandle UP$MH = app_indicator_h.upcallHandle(hb_font_paint_glyph_or_fail_func_t.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(hb_font_paint_glyph_or_fail_func_t.Function fi, Arena arena) {
