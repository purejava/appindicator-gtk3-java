...
final class constants$3036 {
    ...
    static final StructLayout const$2 = MemoryLayout.structLayout(
        ...
        RuntimeHelper.POINTER.withName("priv")
    ).withName("_GtkRecentChooserMenu");
    static final VarHandle const$3 = constants$3036.const$2.varHandle(MemoryLayout.PathElement.groupElement("priv"));
    static final StructLayout const$4 = MemoryLayout.structLayout(
        ...
        RuntimeHelper.POINTER.withName("gtk_recent1"),
        RuntimeHelper.POINTER.withName("gtk_recent2"),
        RuntimeHelper.POINTER.withName("gtk_recent3"),
        RuntimeHelper.POINTER.withName("gtk_recent4")
    ).withName("_GtkRecentChooserMenuClass");
    static final MethodHandle const$5 = RuntimeHelper.upcallHandle(_GtkRecentChooserMenuClass.gtk_recent1.class, "apply", constants$7.const$5);
}
