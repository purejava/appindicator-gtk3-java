...
public interface hb_font_get_glyph_name_func_t {
    ...
    static MemorySegment allocate(hb_font_get_glyph_name_func_t fi, SegmentScope scope) {
        return RuntimeHelper.upcallStub(constants$864.hb_font_get_glyph_name_func_t_UP$MH, fi, constants$864.hb_font_get_glyph_name_func_t$FUNC, scope);
    }
    static hb_font_get_glyph_name_func_t ofAddress(MemorySegment addr, SegmentScope scope) {
        ...
        return (java.lang.foreign.MemorySegment _font, java.lang.foreign.MemorySegment _font_data, int _glyph, java.lang.foreign.MemorySegment _name, int _size, java.lang.foreign.MemorySegment _user_data) -> {
            try {
                return (int)constants$864.hb_font_get_glyph_name_func_t_DOWN$MH.invokeExact(symbol, _font, _font_data, _glyph, _name, _size, _user_data);
            } catch (Throwable ex$) {
