...
public class _GdkEventProximity {
    ...
    public static int type$get(MemorySegment seg) {
        return (int)constants$1794.const$2.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static int type$get(MemorySegment seg, long index) {
        return (int)constants$1794.const$2.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemorySegment window$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)constants$1794.const$3.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment window$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)constants$1794.const$3.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static byte send_event$get(MemorySegment seg) {
        return (byte)constants$1794.const$4.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void send_event$set(MemorySegment seg, byte x) {
        constants$1794.const$4.set(seg, x);
    }
    public static byte send_event$get(MemorySegment seg, long index) {
        return (byte)constants$1794.const$4.get(seg.asSlice(index*sizeof()));
    }
    public static void send_event$set(MemorySegment seg, long index, byte x) {
        constants$1794.const$4.set(seg.asSlice(index*sizeof()), x);
    }
