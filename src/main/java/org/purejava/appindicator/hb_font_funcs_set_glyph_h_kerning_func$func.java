...
/**
 * {@snippet :
 * int (*hb_font_funcs_set_glyph_h_kerning_func$func)(struct hb_font_t*,void*,unsigned int,unsigned int,void*);
 * }
 */
public interface hb_font_funcs_set_glyph_h_kerning_func$func {
    ...
    static MemorySegment allocate(hb_font_funcs_set_glyph_h_kerning_func$func fi, Arena scope) {
        return RuntimeHelper.upcallStub(constants$1487.const$3, fi, constants$1479.const$3, scope);
    }
    static hb_font_funcs_set_glyph_h_kerning_func$func ofAddress(MemorySegment addr, Arena arena) {
