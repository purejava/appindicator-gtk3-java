...
/**
 * {@snippet :
 * void (*hb_font_funcs_set_glyph_v_advances_func$func)(struct hb_font_t*,void*,unsigned int,unsigned int*,unsigned int,int*,unsigned int,void*);
 * }
 */
public interface hb_font_funcs_set_glyph_v_advances_func$func {
    ...
    static MemorySegment allocate(hb_font_funcs_set_glyph_v_advances_func$func fi, Arena scope) {
        return RuntimeHelper.upcallStub(constants$1486.const$0, fi, constants$1478.const$1, scope);
    }
    static hb_font_funcs_set_glyph_v_advances_func$func ofAddress(MemorySegment addr, Arena arena) {
