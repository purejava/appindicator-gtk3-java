...
public class _GtkLevelBarClass {
     ...
     * }
     */
    public final static class offset_changed {

        private offset_changed() {
            // Should not be called directly
        }
    ...
    private static final long offset_changed$OFFSET = $LAYOUT.byteOffset(groupElement("offset_changed"));
