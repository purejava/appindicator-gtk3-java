...
/**
 * {@snippet :
 * int (*g_signal_new$accumulator)(struct _GSignalInvocationHint*,struct _GValue*,struct _GValue*,void*);
 * }
 */
public interface g_signal_new$accumulator {
    ...
    static MemorySegment allocate(g_signal_new$accumulator fi, Arena scope) {
        return RuntimeHelper.upcallStub(constants$603.const$4, fi, constants$34.const$5, scope);
    }
    static g_signal_new$accumulator ofAddress(MemorySegment addr, Arena arena) {
