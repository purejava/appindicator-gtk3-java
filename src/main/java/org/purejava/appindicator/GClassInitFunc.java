 ...
 * }
 */
public final class GClassInitFunc {

    private GClassInitFunc() {
    ...
    private static final MethodHandle UP$MH = app_indicator_h.upcallHandle(GClassInitFunc.Function.class, "apply", $DESC);
