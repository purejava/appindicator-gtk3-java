...
final class constants$2850 {
    ...
    static final VarHandle const$0 = constants$2846.const$2.varHandle(MemoryLayout.PathElement.groupElement("_gtk_reserved3"));
    ...
    static final MethodHandle const$3 = RuntimeHelper.upcallHandle(_GtkListBoxRowClass.activate.class, "apply", constants$13.const$1);
    static final VarHandle const$4 = constants$2850.const$2.varHandle(MemoryLayout.PathElement.groupElement("activate"));
    static final MethodHandle const$5 = RuntimeHelper.upcallHandle(_GtkListBoxRowClass._gtk_reserved1.class, "apply", constants$7.const$5);
}
