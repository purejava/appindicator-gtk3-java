...
final class constants$1003 {
    ...
    static final VarHandle const$0 = constants$974.const$5.varHandle(MemoryLayout.PathElement.groupElement("mount_enclosing_volume"));
    ...
    static final VarHandle const$2 = constants$974.const$5.varHandle(MemoryLayout.PathElement.groupElement("mount_enclosing_volume_finish"));
    static final MethodHandle const$3 = RuntimeHelper.upcallHandle(_GFileIface.monitor_dir.class, "apply", constants$180.const$0);
    static final VarHandle const$4 = constants$974.const$5.varHandle(MemoryLayout.PathElement.groupElement("monitor_dir"));
