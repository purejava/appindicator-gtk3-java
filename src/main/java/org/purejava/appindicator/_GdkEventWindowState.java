...
public class _GdkEventWindowState {
    ...
    public static int type$get(MemorySegment seg) {
        return (int)constants$1796.const$2.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static int type$get(MemorySegment seg, long index) {
        return (int)constants$1796.const$2.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemorySegment window$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)constants$1796.const$3.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment window$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)constants$1796.const$3.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static byte send_event$get(MemorySegment seg) {
        return (byte)constants$1796.const$4.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static byte send_event$get(MemorySegment seg, long index) {
        return (byte)constants$1796.const$4.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static int new_window_state$get(MemorySegment seg) {
        return (int)constants$1797.const$0.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void new_window_state$set(MemorySegment seg, int x) {
        constants$1797.const$0.set(seg, x);
    }
    public static int new_window_state$get(MemorySegment seg, long index) {
        return (int)constants$1797.const$0.get(seg.asSlice(index*sizeof()));
    }
    public static void new_window_state$set(MemorySegment seg, long index, int x) {
        constants$1797.const$0.set(seg.asSlice(index*sizeof()), x);
    }
