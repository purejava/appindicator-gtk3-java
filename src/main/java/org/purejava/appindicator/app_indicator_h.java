...
public class app_indicator_h extends app_indicator_h_1 {
    ...
    private static final int AYATANA_APP_INDICATOR_MAJOR_VERSION = (int)0L;
    /**
     * {@snippet lang=c :
     * #define AYATANA_APP_INDICATOR_MAJOR_VERSION 0
     * }
     */
    public static int AYATANA_APP_INDICATOR_MAJOR_VERSION() {
        return AYATANA_APP_INDICATOR_MAJOR_VERSION;
    }
    private static final int AYATANA_APP_INDICATOR_MINOR_VERSION = (int)5L;
    /**
     * {@snippet lang=c :
     * #define AYATANA_APP_INDICATOR_MINOR_VERSION 5
     * }
     */
    public static int AYATANA_APP_INDICATOR_MINOR_VERSION() {
        return AYATANA_APP_INDICATOR_MINOR_VERSION;
    }
    private static final int AYATANA_APP_INDICATOR_MICRO_VERSION = (int)90L;
    /**
     * {@snippet lang=c :
     * #define AYATANA_APP_INDICATOR_MICRO_VERSION 90
     * }
     */
    public static int AYATANA_APP_INDICATOR_MICRO_VERSION() {
        return AYATANA_APP_INDICATOR_MICRO_VERSION;
    }
    /**
     * {@snippet lang=c :
     * #define AYATANA_APP_INDICATOR_VERSION_S "0.6.0"
     * }
     */
    public static MemorySegment AYATANA_APP_INDICATOR_VERSION_S() {
        class Holder {
            static final MemorySegment AYATANA_APP_INDICATOR_VERSION_S
                = app_indicator_h.LIBRARY_ARENA.allocateFrom("0.6.0");
        }
        return Holder.AYATANA_APP_INDICATOR_VERSION_S;
    }
    private static final int AYATANA_APP_INDICATOR_VERSION_HEX = (int)350720L;
    /**
     * {@snippet lang=c :
     * #define AYATANA_APP_INDICATOR_VERSION_HEX 350720
     * }
     */
    public static int AYATANA_APP_INDICATOR_VERSION_HEX() {
        return AYATANA_APP_INDICATOR_VERSION_HEX;
    }
    /**
     * {@snippet lang=c :
     ...
     * }
     */
    public static MemorySegment APP_INDICATOR_SIGNAL_NEW_TOOLTIP() {
        class Holder {
            static final MemorySegment APP_INDICATOR_SIGNAL_NEW_TOOLTIP
                = app_indicator_h.LIBRARY_ARENA.allocateFrom("new-tooltip");
        }
        return Holder.APP_INDICATOR_SIGNAL_NEW_TOOLTIP;
    }
    /**
     * {@snippet lang=c :
     ...
     * }
     */
    public static MemorySegment APP_INDICATOR_SIGNAL_ACTIVATE_EVENT() {
        class Holder {
            static final MemorySegment APP_INDICATOR_SIGNAL_ACTIVATE_EVENT
                = app_indicator_h.LIBRARY_ARENA.allocateFrom("activate");
        }
        return Holder.APP_INDICATOR_SIGNAL_ACTIVATE_EVENT;
    }
}
