...
final class constants$3124 {
    ...
    static final MethodHandle const$1 = RuntimeHelper.upcallHandle(_GtkTextBufferClass.insert_text.class, "apply", constants$331.const$4);
    static final VarHandle const$2 = constants$3124.const$0.varHandle(MemoryLayout.PathElement.groupElement("insert_text"));
    ...
    static final VarHandle const$4 = constants$3124.const$0.varHandle(MemoryLayout.PathElement.groupElement("insert_pixbuf"));
