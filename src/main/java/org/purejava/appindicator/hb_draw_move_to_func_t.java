 ...
 * }
 */
public class hb_draw_move_to_func_t {
    ...
    private static final MethodHandle UP$MH = app_indicator_h.upcallHandle(hb_draw_move_to_func_t.Function.class, "apply", $DESC);
