...
public class _GMenuAttributeIterClass {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        app_indicator_h.C_POINTER.withName("get_next")
     ...
     * }
     */
    public final static class get_next {
        ...
        private static final MethodHandle UP$MH = app_indicator_h.upcallHandle(get_next.Function.class, "apply", $DESC);
    ...
    private static final long get_next$OFFSET = $LAYOUT.byteOffset(groupElement("get_next"));
