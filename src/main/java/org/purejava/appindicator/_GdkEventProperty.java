...
public class _GdkEventProperty {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        app_indicator_h.C_POINTER.withName("atom"),
    ...
    private static final AddressLayout atom$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("atom"));
     ...
     * }
     */
    public static final AddressLayout atom$layout() {
        return atom$LAYOUT;
    }
     ...
     * }
     */
    public static MemorySegment atom(MemorySegment struct) {
     ...
     * }
     */
    public static void atom(MemorySegment struct, MemorySegment fieldValue) {
