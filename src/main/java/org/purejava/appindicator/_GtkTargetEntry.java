...
public class _GtkTargetEntry {
    ...
    public static MemorySegment target$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)constants$2389.const$4.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment target$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)constants$2389.const$4.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static int flags$get(MemorySegment seg) {
        return (int)constants$2389.const$5.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static int flags$get(MemorySegment seg, long index) {
        return (int)constants$2389.const$5.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static int info$get(MemorySegment seg) {
        return (int)constants$2390.const$0.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static int info$get(MemorySegment seg, long index) {
        return (int)constants$2390.const$0.get(seg.asSlice(index*sizeof()));
    }
