...
public class _GtkScrolledWindowClass {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        app_indicator_h.C_INT.withName("scrollbar_spacing"),
        MemoryLayout.paddingLayout(4),
        app_indicator_h.C_POINTER.withName("scroll_child"),
    ...
    private static final OfInt scrollbar_spacing$LAYOUT = (OfInt)$LAYOUT.select(groupElement("scrollbar_spacing"));
     ...
     * }
     */
    public static final OfInt scrollbar_spacing$layout() {
        return scrollbar_spacing$LAYOUT;
    }

    private static final long scrollbar_spacing$OFFSET = 1008;
     ...
     * }
     */
    public static final long scrollbar_spacing$offset() {
        return scrollbar_spacing$OFFSET;
    }
     ...
     * }
     */
    public static int scrollbar_spacing(MemorySegment struct) {
        return struct.get(scrollbar_spacing$LAYOUT, scrollbar_spacing$OFFSET);
    }
     ...
     * }
     */
    public static void scrollbar_spacing(MemorySegment struct, int fieldValue) {
        struct.set(scrollbar_spacing$LAYOUT, scrollbar_spacing$OFFSET, fieldValue);
    }
    ...
    public class scroll_child {
        ...
        private static final MethodHandle UP$MH = app_indicator_h.upcallHandle(scroll_child.Function.class, "apply", $DESC);

        /**
         * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
         * The lifetime of the returned segment is managed by {@code arena}
         */
        public static MemorySegment allocate(scroll_child.Function fi, Arena arena) {
    ...
    private static final AddressLayout scroll_child$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("scroll_child"));
     ...
     * }
     */
    public static final AddressLayout scroll_child$layout() {
        return scroll_child$LAYOUT;
    }

    private static final long scroll_child$OFFSET = 1016;
     ...
     * }
     */
    public static final long scroll_child$offset() {
        return scroll_child$OFFSET;
    }
     ...
     * }
     */
    public static MemorySegment scroll_child(MemorySegment struct) {
        return struct.get(scroll_child$LAYOUT, scroll_child$OFFSET);
    }
     ...
     * }
     */
    public static void scroll_child(MemorySegment struct, MemorySegment fieldValue) {
        struct.set(scroll_child$LAYOUT, scroll_child$OFFSET, fieldValue);
    }
    ...
    private static final long move_focus_out$OFFSET = 1024;
