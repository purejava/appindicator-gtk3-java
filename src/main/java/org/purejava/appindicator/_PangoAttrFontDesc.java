...
public class _PangoAttrFontDesc {
    ...
    public static MemorySegment desc$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)constants$1571.const$3.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment desc$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)constants$1571.const$3.get(seg.asSlice(index*sizeof()));
    }
