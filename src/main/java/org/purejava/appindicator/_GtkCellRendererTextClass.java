...
public class _GtkCellRendererTextClass {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        app_indicator_h.C_POINTER.withName("edited"),
    ...
    public class edited {
        ...
        private static final MethodHandle UP$MH = app_indicator_h.upcallHandle(edited.Function.class, "apply", $DESC);

        /**
         * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
         * The lifetime of the returned segment is managed by {@code arena}
         */
        public static MemorySegment allocate(edited.Function fi, Arena arena) {
    ...
    private static final AddressLayout edited$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("edited"));
     ...
     * }
     */
    public static final AddressLayout edited$layout() {
        return edited$LAYOUT;
    }

    private static final long edited$OFFSET = 264;
     ...
     * }
     */
    public static MemorySegment edited(MemorySegment struct) {
     ...
     * }
     */
    public static void edited(MemorySegment struct, MemorySegment fieldValue) {
