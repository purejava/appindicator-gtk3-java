...
public class _GtkColorButtonClass {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        app_indicator_h.C_POINTER.withName("color_set"),
     ...
     * }
     */
    public final static class color_set {
        ...
        private static final MethodHandle UP$MH = app_indicator_h.upcallHandle(color_set.Function.class, "apply", $DESC);

        /**
         * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
         * The lifetime of the returned segment is managed by {@code arena}
         */
        public static MemorySegment allocate(color_set.Function fi, Arena arena) {
    ...
    private static final AddressLayout color_set$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("color_set"));
     ...
     * }
     */
    public static final AddressLayout color_set$layout() {
        return color_set$LAYOUT;
    }

    private static final long color_set$OFFSET = $LAYOUT.byteOffset(groupElement("color_set"));
     ...
     * }
     */
    public static final long color_set$offset() {
        return color_set$OFFSET;
    }
     ...
     * }
     */
    public static MemorySegment color_set(MemorySegment struct) {
        return struct.get(color_set$LAYOUT, color_set$OFFSET);
    }
     ...
     * }
     */
    public static void color_set(MemorySegment struct, MemorySegment fieldValue) {
        struct.set(color_set$LAYOUT, color_set$OFFSET, fieldValue);
    }
