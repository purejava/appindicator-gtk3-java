...
public class _GtkBindingArg {
    ...
    public static long arg_type$get(MemorySegment seg) {
        return (long)constants$2536.const$0.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static long arg_type$get(MemorySegment seg, long index) {
        return (long)constants$2536.const$0.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static final class d {
        ...
        public static long long_data$get(MemorySegment seg) {
            return (long)constants$2536.const$2.get(seg);
        }
        /**
         * Setter for field:
         * {@snippet :
        ...
        public static long long_data$get(MemorySegment seg, long index) {
            return (long)constants$2536.const$2.get(seg.asSlice(index*sizeof()));
        }
        ...
        public static double double_data$get(MemorySegment seg) {
            return (double)constants$2536.const$3.get(seg);
        }
        /**
         * Setter for field:
         * {@snippet :
        ...
        public static double double_data$get(MemorySegment seg, long index) {
            return (double)constants$2536.const$3.get(seg.asSlice(index*sizeof()));
        }
        ...
        public static MemorySegment string_data$get(MemorySegment seg) {
            return (java.lang.foreign.MemorySegment)constants$2536.const$4.get(seg);
        }
        /**
         * Setter for field:
         * {@snippet :
        ...
        public static MemorySegment string_data$get(MemorySegment seg, long index) {
            return (java.lang.foreign.MemorySegment)constants$2536.const$4.get(seg.asSlice(index*sizeof()));
        }
