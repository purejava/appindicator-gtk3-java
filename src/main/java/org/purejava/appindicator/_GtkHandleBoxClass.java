...
public class _GtkHandleBoxClass {
    ...
    private static final long child_attached$OFFSET = 1008;
    ...
    private static final long child_detached$OFFSET = 1016;
