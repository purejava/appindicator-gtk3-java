...
public class _GtkHandleBoxClass {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        app_indicator_h.C_POINTER.withName("child_attached"),
        app_indicator_h.C_POINTER.withName("child_detached"),
     ...
     * }
     */
    public final static class child_attached {

        private child_attached() {
            // Should not be called directly
        }
        ...
        private static final MethodHandle UP$MH = app_indicator_h.upcallHandle(child_attached.Function.class, "apply", $DESC);

        /**
         * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
         * The lifetime of the returned segment is managed by {@code arena}
         */
        public static MemorySegment allocate(child_attached.Function fi, Arena arena) {
    ...
    private static final AddressLayout child_attached$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("child_attached"));
     ...
     * }
     */
    public static final AddressLayout child_attached$layout() {
        return child_attached$LAYOUT;
    }

    private static final long child_attached$OFFSET = $LAYOUT.byteOffset(groupElement("child_attached"));
     ...
     * }
     */
    public static final long child_attached$offset() {
        return child_attached$OFFSET;
    }
     ...
     * }
     */
    public static MemorySegment child_attached(MemorySegment struct) {
        return struct.get(child_attached$LAYOUT, child_attached$OFFSET);
    }
     ...
     * }
     */
    public static void child_attached(MemorySegment struct, MemorySegment fieldValue) {
        struct.set(child_attached$LAYOUT, child_attached$OFFSET, fieldValue);
    }
     ...
     * }
     */
    public final static class child_detached {

        private child_detached() {
            // Should not be called directly
        }
        ...
        private static final MethodHandle UP$MH = app_indicator_h.upcallHandle(child_detached.Function.class, "apply", $DESC);

        /**
         * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
         * The lifetime of the returned segment is managed by {@code arena}
         */
        public static MemorySegment allocate(child_detached.Function fi, Arena arena) {
            return Linker.nativeLinker().upcallStub(UP$MH.bindTo(fi), $DESC, arena);
        }
    ...
    private static final AddressLayout child_detached$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("child_detached"));
     ...
     * }
     */
    public static final AddressLayout child_detached$layout() {
        return child_detached$LAYOUT;
    }

    private static final long child_detached$OFFSET = $LAYOUT.byteOffset(groupElement("child_detached"));
     ...
     * }
     */
    public static final long child_detached$offset() {
        return child_detached$OFFSET;
    }
     ...
     * }
     */
    public static MemorySegment child_detached(MemorySegment struct) {
        return struct.get(child_detached$LAYOUT, child_detached$OFFSET);
    }
     ...
     * }
     */
    public static void child_detached(MemorySegment struct, MemorySegment fieldValue) {
        struct.set(child_detached$LAYOUT, child_detached$OFFSET, fieldValue);
    }
