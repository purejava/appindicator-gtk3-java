...
final class constants$3117 {
    ...
    static final VarHandle const$3 = constants$3117.const$2.varHandle(MemoryLayout.PathElement.groupElement("priv"));
    static final StructLayout const$4 = MemoryLayout.structLayout(
        ...
        RuntimeHelper.POINTER.withName("state_set"),
        RuntimeHelper.POINTER.withName("_switch_padding_1"),
        RuntimeHelper.POINTER.withName("_switch_padding_2"),
        RuntimeHelper.POINTER.withName("_switch_padding_3"),
        RuntimeHelper.POINTER.withName("_switch_padding_4"),
        RuntimeHelper.POINTER.withName("_switch_padding_5")
    ).withName("_GtkSwitchClass");
    static final MethodHandle const$5 = RuntimeHelper.upcallHandle(_GtkSwitchClass.activate.class, "apply", constants$13.const$1);
}
