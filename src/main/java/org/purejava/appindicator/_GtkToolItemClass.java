...
public class _GtkToolItemClass {
     ...
     * }
     */
    public final static class create_menu_proxy {

        private create_menu_proxy() {
            // Should not be called directly
        }
    ...
    private static final long create_menu_proxy$OFFSET = $LAYOUT.byteOffset(groupElement("create_menu_proxy"));
     ...
     * }
     */
    public final static class toolbar_reconfigured {

        private toolbar_reconfigured() {
            // Should not be called directly
        }
    ...
    private static final long toolbar_reconfigured$OFFSET = $LAYOUT.byteOffset(groupElement("toolbar_reconfigured"));
