...
final class constants$2617 {
    ...
    static final MethodHandle const$1 = RuntimeHelper.upcallHandle(_GtkMenuItemClass.activate.class, "apply", constants$13.const$1);
    static final VarHandle const$2 = constants$2617.const$0.varHandle(MemoryLayout.PathElement.groupElement("activate"));
    static final MethodHandle const$3 = RuntimeHelper.upcallHandle(_GtkMenuItemClass.activate_item.class, "apply", constants$13.const$1);
    static final VarHandle const$4 = constants$2617.const$0.varHandle(MemoryLayout.PathElement.groupElement("activate_item"));
    static final MethodHandle const$5 = RuntimeHelper.upcallHandle(_GtkMenuItemClass.toggle_size_request.class, "apply", constants$13.const$4);
}
