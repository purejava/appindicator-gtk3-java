...
public class _AtkSocket {
    ...
    public static MemorySegment embedded_plug_id$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)constants$2060.const$2.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment embedded_plug_id$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)constants$2060.const$2.get(seg.asSlice(index*sizeof()));
    }
