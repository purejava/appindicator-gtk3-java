...
final class constants$2822 {
    ...
    static final VarHandle const$3 = constants$2822.const$2.varHandle(MemoryLayout.PathElement.groupElement("priv"));
    ...
    static final MethodHandle const$5 = RuntimeHelper.upcallHandle(_GtkInfoBarClass.response.class, "apply", constants$40.const$2);
}
