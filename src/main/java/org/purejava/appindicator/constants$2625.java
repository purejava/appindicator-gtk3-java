...
final class constants$2625 {
    ...
    static final StructLayout const$0 = MemoryLayout.structLayout(
        MemoryLayout.structLayout(
            ...
            RuntimeHelper.POINTER.withName("activate_item"),
            RuntimeHelper.POINTER.withName("toggle_size_request"),
            RuntimeHelper.POINTER.withName("toggle_size_allocate"),
            RuntimeHelper.POINTER.withName("set_label"),
            RuntimeHelper.POINTER.withName("get_label"),
            RuntimeHelper.POINTER.withName("select"),
            RuntimeHelper.POINTER.withName("deselect"),
            RuntimeHelper.POINTER.withName("_gtk_reserved1"),
            RuntimeHelper.POINTER.withName("_gtk_reserved2"),
            RuntimeHelper.POINTER.withName("_gtk_reserved3"),
            RuntimeHelper.POINTER.withName("_gtk_reserved4")
    ...
    static final MethodHandle const$1 = RuntimeHelper.upcallHandle(_GtkCheckMenuItemClass.toggled.class, "apply", constants$13.const$1);
    static final VarHandle const$2 = constants$2625.const$0.varHandle(MemoryLayout.PathElement.groupElement("toggled"));
    static final MethodHandle const$3 = RuntimeHelper.upcallHandle(_GtkCheckMenuItemClass.draw_indicator.class, "apply", constants$13.const$4);
    static final VarHandle const$4 = constants$2625.const$0.varHandle(MemoryLayout.PathElement.groupElement("draw_indicator"));
    static final MethodHandle const$5 = RuntimeHelper.upcallHandle(_GtkCheckMenuItemClass._gtk_reserved1.class, "apply", constants$7.const$5);
}
