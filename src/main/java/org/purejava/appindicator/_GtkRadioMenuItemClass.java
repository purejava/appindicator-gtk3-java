...
public class _GtkRadioMenuItemClass {
     ...
     * }
     */
    public final static class group_changed {

        private group_changed() {
            // Should not be called directly
        }
    ...
    private static final long group_changed$OFFSET = $LAYOUT.byteOffset(groupElement("group_changed"));
