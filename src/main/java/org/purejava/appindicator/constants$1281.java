...
final class constants$1281 {
    ...
    static final VarHandle const$0 = constants$1280.const$0.varHandle(MemoryLayout.PathElement.groupElement("_g_reserved3"));
    static final MethodHandle const$1 = RuntimeHelper.upcallHandle(_GSocketClass._g_reserved4.class, "apply", constants$7.const$5);
    static final VarHandle const$2 = constants$1280.const$0.varHandle(MemoryLayout.PathElement.groupElement("_g_reserved4"));
    static final MethodHandle const$3 = RuntimeHelper.upcallHandle(_GSocketClass._g_reserved5.class, "apply", constants$7.const$5);
    static final VarHandle const$4 = constants$1280.const$0.varHandle(MemoryLayout.PathElement.groupElement("_g_reserved5"));
