...
public class _GDebugControllerDBusClass {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        app_indicator_h.C_POINTER.withName("authorize"),
     ...
     * }
     */
    public final static class authorize {
        ...
        private static final MethodHandle UP$MH = app_indicator_h.upcallHandle(authorize.Function.class, "apply", $DESC);

        /**
         * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
         * The lifetime of the returned segment is managed by {@code arena}
         */
        public static MemorySegment allocate(authorize.Function fi, Arena arena) {
    ...
    private static final AddressLayout authorize$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("authorize"));
     ...
     * }
     */
    public static final AddressLayout authorize$layout() {
        return authorize$LAYOUT;
    }

    private static final long authorize$OFFSET = $LAYOUT.byteOffset(groupElement("authorize"));
     ...
     * }
     */
    public static final long authorize$offset() {
        return authorize$OFFSET;
    }
     ...
     * }
     */
    public static MemorySegment authorize(MemorySegment struct) {
        return struct.get(authorize$LAYOUT, authorize$OFFSET);
    }
     ...
     * }
     */
    public static void authorize(MemorySegment struct, MemorySegment fieldValue) {
        struct.set(authorize$LAYOUT, authorize$OFFSET, fieldValue);
    }
