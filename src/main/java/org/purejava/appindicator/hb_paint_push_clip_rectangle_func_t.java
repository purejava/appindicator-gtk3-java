...
public class hb_paint_push_clip_rectangle_func_t {
    ...
    public interface Function {
        void apply(MemorySegment funcs, MemorySegment paint_data, float xmin, float ymin, float xmax, float ymax, MemorySegment user_data);
    }
    ...
    private static final MethodHandle UP$MH = app_indicator_h.upcallHandle(hb_paint_push_clip_rectangle_func_t.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(hb_paint_push_clip_rectangle_func_t.Function fi, Arena arena) {
