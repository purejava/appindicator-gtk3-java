 ...
 * int (*activate_link)(struct _GtkLinkButton*);
    ...
    public interface activate_link {
        ...
        static MemorySegment allocate(activate_link fi, Arena scope) {
            return RuntimeHelper.upcallStub(constants$2843.const$2, fi, constants$10.const$5, scope);
        }
    ...
    public static MemorySegment activate_link$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)constants$2843.const$3.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment activate_link$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)constants$2843.const$3.get(seg.asSlice(index*sizeof()));
    }
 ...
 * void (*_gtk_padding1)();
    ...
    public interface _gtk_padding1 {
        ...
        static MemorySegment allocate(_gtk_padding1 fi, Arena scope) {
            return RuntimeHelper.upcallStub(constants$2843.const$4, fi, constants$7.const$5, scope);
        }
    ...
    public static MemorySegment _gtk_padding1$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)constants$2843.const$5.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment _gtk_padding1$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)constants$2843.const$5.get(seg.asSlice(index*sizeof()));
    }
 ...
 * void (*_gtk_padding2)();
    ...
    public interface _gtk_padding2 {
        ...
        static MemorySegment allocate(_gtk_padding2 fi, Arena scope) {
            return RuntimeHelper.upcallStub(constants$2844.const$0, fi, constants$7.const$5, scope);
        }
    ...
    public static MemorySegment _gtk_padding2$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)constants$2844.const$1.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void _gtk_padding2$set(MemorySegment seg, MemorySegment x) {
        constants$2844.const$1.set(seg, x);
    }
    public static MemorySegment _gtk_padding2$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)constants$2844.const$1.get(seg.asSlice(index*sizeof()));
    }
    public static void _gtk_padding2$set(MemorySegment seg, long index, MemorySegment x) {
        constants$2844.const$1.set(seg.asSlice(index*sizeof()), x);
    }
 ...
 * void (*_gtk_padding3)();
    ...
    public interface _gtk_padding3 {
        ...
        static MemorySegment allocate(_gtk_padding3 fi, Arena scope) {
            return RuntimeHelper.upcallStub(constants$2844.const$2, fi, constants$7.const$5, scope);
        }
 ...
 * void (*_gtk_padding4)();
    ...
    public interface _gtk_padding4 {
        ...
        static MemorySegment allocate(_gtk_padding4 fi, Arena scope) {
            return RuntimeHelper.upcallStub(constants$2844.const$4, fi, constants$7.const$5, scope);
        }
