...
final class constants$2034 {
    ...
    static final MethodHandle const$1 = RuntimeHelper.upcallHandle(_AtkGObjectAccessibleClass.pad1.class, "apply", constants$10.const$5);
    static final VarHandle const$2 = constants$2034.const$0.varHandle(MemoryLayout.PathElement.groupElement("pad1"));
    static final MethodHandle const$3 = RuntimeHelper.upcallHandle(_AtkGObjectAccessibleClass.pad2.class, "apply", constants$10.const$5);
    static final VarHandle const$4 = constants$2034.const$0.varHandle(MemoryLayout.PathElement.groupElement("pad2"));
