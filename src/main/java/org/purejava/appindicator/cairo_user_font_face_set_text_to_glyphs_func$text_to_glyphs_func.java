...
/**
 * {@snippet :
 * enum _cairo_status (*cairo_user_font_face_set_text_to_glyphs_func$text_to_glyphs_func)(struct _cairo_scaled_font*,char*,int,struct cairo_glyph_t**,int*,struct cairo_text_cluster_t**,int*,enum _cairo_text_cluster_flags*);
 * }
 */
public interface cairo_user_font_face_set_text_to_glyphs_func$text_to_glyphs_func {
    ...
    static MemorySegment allocate(cairo_user_font_face_set_text_to_glyphs_func$text_to_glyphs_func fi, Arena scope) {
        return RuntimeHelper.upcallStub(constants$1713.const$0, fi, constants$1711.const$2, scope);
    }
    static cairo_user_font_face_set_text_to_glyphs_func$text_to_glyphs_func ofAddress(MemorySegment addr, Arena arena) {
