...
final class constants$2923 {
    ...
    static final MethodHandle const$4 = RuntimeHelper.upcallHandle(_GtkOffscreenWindowClass._gtk_reserved1.class, "apply", constants$7.const$5);
    static final VarHandle const$5 = constants$2923.const$3.varHandle(MemoryLayout.PathElement.groupElement("_gtk_reserved1"));
}
