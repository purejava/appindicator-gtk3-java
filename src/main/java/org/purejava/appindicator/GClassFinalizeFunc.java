 ...
 * }
 */
public final class GClassFinalizeFunc {

    private GClassFinalizeFunc() {
    ...
    private static final MethodHandle UP$MH = app_indicator_h.upcallHandle(GClassFinalizeFunc.Function.class, "apply", $DESC);
