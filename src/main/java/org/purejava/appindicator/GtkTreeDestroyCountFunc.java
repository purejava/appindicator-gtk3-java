...
public class GtkTreeDestroyCountFunc {
    ...
    public interface Function {
        void apply(MemorySegment tree_view, MemorySegment path, int children, MemorySegment user_data);
    }
    ...
    private static final MethodHandle UP$MH = app_indicator_h.upcallHandle(GtkTreeDestroyCountFunc.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(GtkTreeDestroyCountFunc.Function fi, Arena arena) {
