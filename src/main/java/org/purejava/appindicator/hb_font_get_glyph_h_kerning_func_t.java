...
public interface hb_font_get_glyph_h_kerning_func_t {
    ...
    static MemorySegment allocate(hb_font_get_glyph_h_kerning_func_t fi, SegmentScope scope) {
        return RuntimeHelper.upcallStub(constants$863.hb_font_get_glyph_h_kerning_func_t_UP$MH, fi, constants$863.hb_font_get_glyph_h_kerning_func_t$FUNC, scope);
    }
    static hb_font_get_glyph_h_kerning_func_t ofAddress(MemorySegment addr, SegmentScope scope) {
        ...
        return (java.lang.foreign.MemorySegment _font, java.lang.foreign.MemorySegment _font_data, int _first_glyph, int _second_glyph, java.lang.foreign.MemorySegment _user_data) -> {
            try {
                return (int)constants$863.hb_font_get_glyph_h_kerning_func_t_DOWN$MH.invokeExact(symbol, _font, _font_data, _first_glyph, _second_glyph, _user_data);
            } catch (Throwable ex$) {
