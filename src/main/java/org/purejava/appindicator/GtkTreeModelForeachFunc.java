...
public class GtkTreeModelForeachFunc {
    ...
    public interface Function {
        int apply(MemorySegment model, MemorySegment path, MemorySegment iter, MemorySegment data);
    }
    ...
    private static final MethodHandle UP$MH = app_indicator_h.upcallHandle(GtkTreeModelForeachFunc.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(GtkTreeModelForeachFunc.Function fi, Arena arena) {
