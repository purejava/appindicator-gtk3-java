...
final class constants$1162 {
    ...
    static final VarHandle const$1 = constants$1159.const$1.varHandle(MemoryLayout.PathElement.groupElement("can_unmount"));
    static final MethodHandle const$2 = RuntimeHelper.upcallHandle(_GMountIface.can_eject.class, "apply", constants$10.const$5);
    static final VarHandle const$3 = constants$1159.const$1.varHandle(MemoryLayout.PathElement.groupElement("can_eject"));
    static final MethodHandle const$4 = RuntimeHelper.upcallHandle(_GMountIface.unmount.class, "apply", constants$281.const$5);
    static final VarHandle const$5 = constants$1159.const$1.varHandle(MemoryLayout.PathElement.groupElement("unmount"));
}
