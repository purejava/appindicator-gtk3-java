...
final class constants$1716 {
    ...
    static final MethodHandle const$1 = RuntimeHelper.upcallHandle(cairo_user_scaled_font_render_glyph_func_t.class, "apply", constants$394.const$4);
    ...
    static final MethodHandle const$3 = RuntimeHelper.upcallHandle(cairo_user_scaled_font_text_to_glyphs_func_t.class, "apply", constants$1716.const$2);
    static final MethodHandle const$4 = RuntimeHelper.downcallHandle(
        constants$1716.const$2
    );
