...
/**
 * {@snippet :
 * void (*g_log_set_default_handler$log_func)(char*,enum GLogLevelFlags,char*,void*);
 * }
 */
public interface g_log_set_default_handler$log_func {
    ...
    static MemorySegment allocate(g_log_set_default_handler$log_func fi, Arena scope) {
        return RuntimeHelper.upcallStub(constants$374.const$0, fi, constants$179.const$1, scope);
    }
    static g_log_set_default_handler$log_func ofAddress(MemorySegment addr, Arena arena) {
