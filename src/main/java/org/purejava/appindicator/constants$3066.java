...
final class constants$3066 {
    ...
    static final StructLayout const$0 = MemoryLayout.structLayout(
        ...
        RuntimeHelper.POINTER.withName("priv")
    ).withName("_GtkScrolledWindow");
    static final VarHandle const$1 = constants$3066.const$0.varHandle(MemoryLayout.PathElement.groupElement("priv"));
    static final StructLayout const$2 = MemoryLayout.structLayout(
        ...
        JAVA_INT.withName("scrollbar_spacing"),
        MemoryLayout.paddingLayout(4),
        RuntimeHelper.POINTER.withName("scroll_child"),
        RuntimeHelper.POINTER.withName("move_focus_out"),
        RuntimeHelper.POINTER.withName("_gtk_reserved1"),
        RuntimeHelper.POINTER.withName("_gtk_reserved2"),
        RuntimeHelper.POINTER.withName("_gtk_reserved3"),
        RuntimeHelper.POINTER.withName("_gtk_reserved4")
    ).withName("_GtkScrolledWindowClass");
    static final VarHandle const$3 = constants$3066.const$2.varHandle(MemoryLayout.PathElement.groupElement("scrollbar_spacing"));
    static final MethodHandle const$4 = RuntimeHelper.upcallHandle(_GtkScrolledWindowClass.scroll_child.class, "apply", constants$49.const$0);
    static final VarHandle const$5 = constants$3066.const$2.varHandle(MemoryLayout.PathElement.groupElement("scroll_child"));
}
