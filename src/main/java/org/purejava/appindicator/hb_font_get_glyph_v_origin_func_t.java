...
public interface hb_font_get_glyph_v_origin_func_t {
    ...
    static MemorySegment allocate(hb_font_get_glyph_v_origin_func_t fi, Arena scope) {
        return RuntimeHelper.upcallStub(constants$1484.const$3, fi, constants$1247.const$0, scope);
    }
    static hb_font_get_glyph_v_origin_func_t ofAddress(MemorySegment addr, Arena arena) {
