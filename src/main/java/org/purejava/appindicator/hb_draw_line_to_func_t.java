...
public interface hb_draw_line_to_func_t {
    ...
    static MemorySegment allocate(hb_draw_line_to_func_t fi, Arena scope) {
        return RuntimeHelper.upcallStub(constants$1451.const$4, fi, constants$1451.const$1, scope);
    }
    static hb_draw_line_to_func_t ofAddress(MemorySegment addr, Arena arena) {
