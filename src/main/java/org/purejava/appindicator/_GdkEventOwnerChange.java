...
public class _GdkEventOwnerChange {
    ...
    public static MemorySegment window$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)constants$1793.const$0.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment window$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)constants$1793.const$0.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static byte send_event$get(MemorySegment seg) {
        return (byte)constants$1793.const$1.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static byte send_event$get(MemorySegment seg, long index) {
        return (byte)constants$1793.const$1.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemorySegment owner$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)constants$1793.const$2.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void owner$set(MemorySegment seg, MemorySegment x) {
        constants$1793.const$2.set(seg, x);
    }
    public static MemorySegment owner$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)constants$1793.const$2.get(seg.asSlice(index*sizeof()));
    }
    public static void owner$set(MemorySegment seg, long index, MemorySegment x) {
        constants$1793.const$2.set(seg.asSlice(index*sizeof()), x);
    }
    ...
    public static int time$get(MemorySegment seg) {
        return (int)constants$1793.const$5.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static int time$get(MemorySegment seg, long index) {
        return (int)constants$1793.const$5.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static int selection_time$get(MemorySegment seg) {
        return (int)constants$1794.const$0.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static int selection_time$get(MemorySegment seg, long index) {
        return (int)constants$1794.const$0.get(seg.asSlice(index*sizeof()));
    }
