...
final class constants$3407 {
    ...
    static final StructLayout const$4 = MemoryLayout.structLayout(
        ...
        RuntimeHelper.POINTER.withName("new_icon"),
        RuntimeHelper.POINTER.withName("new_attention_icon"),
        RuntimeHelper.POINTER.withName("new_status"),
        RuntimeHelper.POINTER.withName("new_icon_theme_path"),
        RuntimeHelper.POINTER.withName("new_label"),
        RuntimeHelper.POINTER.withName("connection_changed"),
        RuntimeHelper.POINTER.withName("scroll_event"),
        RuntimeHelper.POINTER.withName("app_indicator_reserved_ats"),
        RuntimeHelper.POINTER.withName("fallback"),
        RuntimeHelper.POINTER.withName("unfallback"),
        RuntimeHelper.POINTER.withName("app_indicator_reserved_1"),
        RuntimeHelper.POINTER.withName("app_indicator_reserved_2"),
        RuntimeHelper.POINTER.withName("app_indicator_reserved_3"),
        RuntimeHelper.POINTER.withName("app_indicator_reserved_4"),
        RuntimeHelper.POINTER.withName("app_indicator_reserved_5"),
        RuntimeHelper.POINTER.withName("app_indicator_reserved_6")
    ).withName("_AppIndicatorClass");
    static final MethodHandle const$5 = RuntimeHelper.upcallHandle(_AppIndicatorClass.new_icon.class, "apply", constants$13.const$4);
}
