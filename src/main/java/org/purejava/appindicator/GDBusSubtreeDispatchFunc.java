...
public class GDBusSubtreeDispatchFunc {
    ...
    public interface Function {
        MemorySegment apply(MemorySegment connection, MemorySegment sender, MemorySegment object_path, MemorySegment interface_name, MemorySegment node, MemorySegment out_user_data, MemorySegment user_data);
    }
    ...
    private static final MethodHandle UP$MH = app_indicator_h.upcallHandle(GDBusSubtreeDispatchFunc.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(GDBusSubtreeDispatchFunc.Function fi, Arena arena) {
