...
public class _PangoGlyphItemIter {
    ...
    public static MemorySegment glyph_item$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)constants$1621.const$3.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment glyph_item$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)constants$1621.const$3.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemorySegment text$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)constants$1621.const$4.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment text$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)constants$1621.const$4.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static int start_glyph$get(MemorySegment seg) {
        return (int)constants$1621.const$5.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static int start_glyph$get(MemorySegment seg, long index) {
        return (int)constants$1621.const$5.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static int start_index$get(MemorySegment seg) {
        return (int)constants$1622.const$0.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static int start_index$get(MemorySegment seg, long index) {
        return (int)constants$1622.const$0.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static int end_index$get(MemorySegment seg) {
        return (int)constants$1622.const$3.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static int end_index$get(MemorySegment seg, long index) {
        return (int)constants$1622.const$3.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static int end_char$get(MemorySegment seg) {
        return (int)constants$1622.const$4.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void end_char$set(MemorySegment seg, int x) {
        constants$1622.const$4.set(seg, x);
    }
    public static int end_char$get(MemorySegment seg, long index) {
        return (int)constants$1622.const$4.get(seg.asSlice(index*sizeof()));
    }
    public static void end_char$set(MemorySegment seg, long index, int x) {
        constants$1622.const$4.set(seg.asSlice(index*sizeof()), x);
    }
