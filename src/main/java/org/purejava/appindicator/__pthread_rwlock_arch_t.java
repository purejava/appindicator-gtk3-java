...
public class __pthread_rwlock_arch_t {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        app_indicator_h.C_INT.withName("__readers"),
        app_indicator_h.C_INT.withName("__writers"),
        app_indicator_h.C_INT.withName("__wrphase_futex"),
        app_indicator_h.C_INT.withName("__writers_futex"),
        app_indicator_h.C_INT.withName("__pad3"),
        app_indicator_h.C_INT.withName("__pad4"),
        app_indicator_h.C_INT.withName("__cur_writer"),
        app_indicator_h.C_INT.withName("__shared"),
        app_indicator_h.C_LONG.withName("__pad1"),
        app_indicator_h.C_LONG.withName("__pad2"),
        app_indicator_h.C_INT.withName("__flags"),
