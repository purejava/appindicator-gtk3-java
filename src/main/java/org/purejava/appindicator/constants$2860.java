...
final class constants$2860 {
    ...
    static final MethodHandle const$0 = RuntimeHelper.upcallHandle(gtk_list_box_bind_model$create_widget_func.class, "apply", constants$5.const$5);
    static final MethodHandle const$1 = RuntimeHelper.upcallHandle(gtk_list_box_bind_model$user_data_free_func.class, "apply", constants$13.const$1);
    ...
    static final VarHandle const$4 = constants$2860.const$3.varHandle(MemoryLayout.PathElement.groupElement("priv"));
