...
/**
 * {@snippet :
 * void (*gtk_menu_popup$func)(struct _GtkMenu*,int*,int*,int*,void*);
 * }
 */
public interface gtk_menu_popup$func {
    ...
    static MemorySegment allocate(gtk_menu_popup$func fi, Arena scope) {
        return RuntimeHelper.upcallStub(constants$2236.const$4, fi, constants$331.const$1, scope);
    }
    static gtk_menu_popup$func ofAddress(MemorySegment addr, Arena arena) {
