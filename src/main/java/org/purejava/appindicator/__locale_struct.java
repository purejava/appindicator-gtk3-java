...
public class __locale_struct {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        MemoryLayout.sequenceLayout(13, app_indicator_h.C_POINTER).withName("__locales"),
        app_indicator_h.C_POINTER.withName("__ctype_b"),
        app_indicator_h.C_POINTER.withName("__ctype_tolower"),
        app_indicator_h.C_POINTER.withName("__ctype_toupper"),
        MemoryLayout.sequenceLayout(13, app_indicator_h.C_POINTER).withName("__names")
