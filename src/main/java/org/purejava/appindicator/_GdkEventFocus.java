...
public class _GdkEventFocus {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        app_indicator_h.C_SHORT.withName("in"),
        MemoryLayout.paddingLayout(4)
    ...
    private static final OfShort in$LAYOUT = (OfShort)$LAYOUT.select(groupElement("in"));
     ...
     * }
     */
    public static final OfShort in$layout() {
        return in$LAYOUT;
    }
     ...
     * }
     */
    public static short in(MemorySegment struct) {
     ...
     * }
     */
    public static void in(MemorySegment struct, short fieldValue) {
