...
public class _GdkEventVisibility {
    ...
    public static MemorySegment window$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)constants$1774.const$1.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment window$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)constants$1774.const$1.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static byte send_event$get(MemorySegment seg) {
        return (byte)constants$1774.const$2.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static byte send_event$get(MemorySegment seg, long index) {
        return (byte)constants$1774.const$2.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static int state$get(MemorySegment seg) {
        return (int)constants$1774.const$3.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static int state$get(MemorySegment seg, long index) {
        return (int)constants$1774.const$3.get(seg.asSlice(index*sizeof()));
    }
