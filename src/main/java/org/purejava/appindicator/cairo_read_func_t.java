...
public interface cairo_read_func_t {
    ...
    static MemorySegment allocate(cairo_read_func_t fi, Arena scope) {
        return RuntimeHelper.upcallStub(constants$1684.const$2, fi, constants$62.const$0, scope);
    }
    static cairo_read_func_t ofAddress(MemorySegment addr, Arena arena) {
