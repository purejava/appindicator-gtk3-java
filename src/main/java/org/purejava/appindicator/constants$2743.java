...
final class constants$2743 {
    ...
    static final StructLayout const$4 = MemoryLayout.structLayout(
        ...
        RuntimeHelper.POINTER.withName("resize"),
        RuntimeHelper.POINTER.withName("create_context"),
        MemoryLayout.sequenceLayout(6, RuntimeHelper.POINTER).withName("_padding")
    ).withName("_GtkGLAreaClass");
    static final MethodHandle const$5 = RuntimeHelper.upcallHandle(_GtkGLAreaClass.render.class, "apply", constants$9.const$0);
}
