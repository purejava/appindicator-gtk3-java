...
final class constants$2802 {
    ...
    static final VarHandle const$0 = constants$2801.const$5.varHandle(MemoryLayout.PathElement.groupElement("priv"));
    static final StructLayout const$1 = MemoryLayout.structLayout(
        ...
        RuntimeHelper.POINTER.withName("select_cursor_item"),
        RuntimeHelper.POINTER.withName("toggle_cursor_item"),
        RuntimeHelper.POINTER.withName("move_cursor"),
        RuntimeHelper.POINTER.withName("activate_cursor_item"),
        RuntimeHelper.POINTER.withName("_gtk_reserved1"),
        RuntimeHelper.POINTER.withName("_gtk_reserved2"),
        RuntimeHelper.POINTER.withName("_gtk_reserved3"),
        RuntimeHelper.POINTER.withName("_gtk_reserved4")
    ).withName("_GtkIconViewClass");
    static final MethodHandle const$2 = RuntimeHelper.upcallHandle(_GtkIconViewClass.item_activated.class, "apply", constants$13.const$4);
    static final VarHandle const$3 = constants$2802.const$1.varHandle(MemoryLayout.PathElement.groupElement("item_activated"));
    static final MethodHandle const$4 = RuntimeHelper.upcallHandle(_GtkIconViewClass.selection_changed.class, "apply", constants$13.const$1);
    static final VarHandle const$5 = constants$2802.const$1.varHandle(MemoryLayout.PathElement.groupElement("selection_changed"));
}
