...
public class _GOptionEntry {
    ...
    public static byte short_name$get(MemorySegment seg) {
        return (byte)constants$384.const$0.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static byte short_name$get(MemorySegment seg, long index) {
        return (byte)constants$384.const$0.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemorySegment arg_data$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)constants$384.const$3.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment arg_data$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)constants$384.const$3.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemorySegment arg_description$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)constants$384.const$5.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment arg_description$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)constants$384.const$5.get(seg.asSlice(index*sizeof()));
    }
