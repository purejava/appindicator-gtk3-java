...
/**
 * {@snippet :
 * void (*gtk_color_selection_set_change_palette_with_screen_hook$return)(struct _GdkScreen*,struct _GdkColor*,int);
 * }
 */
public interface gtk_color_selection_set_change_palette_with_screen_hook$return {
