...
public class _AtkRectangle {
    ...
    public static int height$get(MemorySegment seg) {
        return (int)constants$1999.const$2.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void height$set(MemorySegment seg, int x) {
        constants$1999.const$2.set(seg, x);
    }
    public static int height$get(MemorySegment seg, long index) {
        return (int)constants$1999.const$2.get(seg.asSlice(index*sizeof()));
    }
    public static void height$set(MemorySegment seg, long index, int x) {
        constants$1999.const$2.set(seg.asSlice(index*sizeof()), x);
    }
