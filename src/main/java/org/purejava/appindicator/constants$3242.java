...
final class constants$3242 {
    ...
    static final VarHandle const$2 = constants$3242.const$1.varHandle(MemoryLayout.PathElement.groupElement("priv"));
    ...
    static final MethodHandle const$4 = RuntimeHelper.upcallHandle(_GtkArrowClass._gtk_reserved1.class, "apply", constants$7.const$5);
    static final VarHandle const$5 = constants$3242.const$3.varHandle(MemoryLayout.PathElement.groupElement("_gtk_reserved1"));
}
