...
final class constants$3076 {
    ...
    static final MethodHandle const$0 = RuntimeHelper.upcallHandle(_GtkSeparatorClass._gtk_reserved4.class, "apply", constants$7.const$5);
    static final VarHandle const$1 = constants$3074.const$5.varHandle(MemoryLayout.PathElement.groupElement("_gtk_reserved4"));
