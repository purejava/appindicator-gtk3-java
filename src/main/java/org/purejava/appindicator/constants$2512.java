...
final class constants$2512 {
    ...
    static final StructLayout const$2 = MemoryLayout.structLayout(
        ...
        RuntimeHelper.POINTER.withName("search")
    ).withName("_GtkShortcutsWindowClass");
    static final MethodHandle const$3 = RuntimeHelper.upcallHandle(_GtkShortcutsWindowClass.close.class, "apply", constants$13.const$1);
    static final VarHandle const$4 = constants$2512.const$2.varHandle(MemoryLayout.PathElement.groupElement("close"));
    static final MethodHandle const$5 = RuntimeHelper.upcallHandle(_GtkShortcutsWindowClass.search.class, "apply", constants$13.const$1);
}
