...
public class _GtkMenuToolButtonClass {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        app_indicator_h.C_POINTER.withName("show_menu"),
    ...
    public class show_menu {
        ...
        private static final MethodHandle UP$MH = app_indicator_h.upcallHandle(show_menu.Function.class, "apply", $DESC);

        /**
         * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
         * The lifetime of the returned segment is managed by {@code arena}
         */
        public static MemorySegment allocate(show_menu.Function fi, Arena arena) {
    ...
    private static final AddressLayout show_menu$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("show_menu"));
     ...
     * }
     */
    public static final AddressLayout show_menu$layout() {
        return show_menu$LAYOUT;
    }

    private static final long show_menu$OFFSET = 1104;
     ...
     * }
     */
    public static final long show_menu$offset() {
        return show_menu$OFFSET;
    }
     ...
     * }
     */
    public static MemorySegment show_menu(MemorySegment struct) {
        return struct.get(show_menu$LAYOUT, show_menu$OFFSET);
    }
     ...
     * }
     */
    public static void show_menu(MemorySegment struct, MemorySegment fieldValue) {
        struct.set(show_menu$LAYOUT, show_menu$OFFSET, fieldValue);
    }
