...
public class hb_font_paint_glyph_func_t {
    ...
    private static final MethodHandle UP$MH = app_indicator_h.upcallHandle(hb_font_paint_glyph_func_t.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(hb_font_paint_glyph_func_t.Function fi, Arena arena) {
