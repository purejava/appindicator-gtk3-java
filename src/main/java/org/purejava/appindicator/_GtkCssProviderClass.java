...
public class _GtkCssProviderClass {
     ...
     * }
     */
    public final static class parsing_error {

        private parsing_error() {
            // Should not be called directly
        }
    ...
    private static final long parsing_error$OFFSET = $LAYOUT.byteOffset(groupElement("parsing_error"));
