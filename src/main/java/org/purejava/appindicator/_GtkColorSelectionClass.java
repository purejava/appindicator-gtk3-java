...
public class _GtkColorSelectionClass {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        app_indicator_h.C_POINTER.withName("color_changed"),
    ...
    public class color_changed {
        ...
        private static final MethodHandle UP$MH = app_indicator_h.upcallHandle(color_changed.Function.class, "apply", $DESC);

        /**
         * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
         * The lifetime of the returned segment is managed by {@code arena}
         */
        public static MemorySegment allocate(color_changed.Function fi, Arena arena) {
    ...
    private static final AddressLayout color_changed$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("color_changed"));
     ...
     * }
     */
    public static final AddressLayout color_changed$layout() {
        return color_changed$LAYOUT;
    }

    private static final long color_changed$OFFSET = 1008;
     ...
     * }
     */
    public static final long color_changed$offset() {
        return color_changed$OFFSET;
    }
     ...
     * }
     */
    public static MemorySegment color_changed(MemorySegment struct) {
        return struct.get(color_changed$LAYOUT, color_changed$OFFSET);
    }
     ...
     * }
     */
    public static void color_changed(MemorySegment struct, MemorySegment fieldValue) {
        struct.set(color_changed$LAYOUT, color_changed$OFFSET, fieldValue);
    }
