...
public class _GtkColorSelectionClass {
     ...
     * }
     */
    public final static class color_changed {

        private color_changed() {
            // Should not be called directly
        }
    ...
    private static final long color_changed$OFFSET = $LAYOUT.byteOffset(groupElement("color_changed"));
