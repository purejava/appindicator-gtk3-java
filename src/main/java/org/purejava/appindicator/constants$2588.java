...
final class constants$2588 {
    ...
    static final StructLayout const$0 = MemoryLayout.structLayout(
        ...
        RuntimeHelper.POINTER.withName("accel_edited"),
        RuntimeHelper.POINTER.withName("accel_cleared"),
    ...
    static final MethodHandle const$1 = RuntimeHelper.upcallHandle(_GtkCellRendererAccelClass.accel_edited.class, "apply", constants$1518.const$2);
    static final VarHandle const$2 = constants$2588.const$0.varHandle(MemoryLayout.PathElement.groupElement("accel_edited"));
    static final MethodHandle const$3 = RuntimeHelper.upcallHandle(_GtkCellRendererAccelClass.accel_cleared.class, "apply", constants$13.const$4);
    static final VarHandle const$4 = constants$2588.const$0.varHandle(MemoryLayout.PathElement.groupElement("accel_cleared"));
    static final MethodHandle const$5 = RuntimeHelper.upcallHandle(_GtkCellRendererAccelClass._gtk_reserved0.class, "apply", constants$7.const$5);
}
