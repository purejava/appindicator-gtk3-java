...
public class GtkFontFilterFunc {
    ...
    public interface Function {
        int apply(MemorySegment family, MemorySegment face, MemorySegment data);
    }
    ...
    private static final MethodHandle UP$MH = app_indicator_h.upcallHandle(GtkFontFilterFunc.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(GtkFontFilterFunc.Function fi, Arena arena) {
