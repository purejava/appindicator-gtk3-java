...
final class constants$2239 {
    ...
    static final MethodHandle const$0 = RuntimeHelper.upcallHandle(GtkMenuPositionFunc.class, "apply", constants$332.const$1);
    static final MethodHandle const$1 = RuntimeHelper.upcallHandle(GtkMenuDetachFunc.class, "apply", constants$13.const$4);
    ...
    static final VarHandle const$3 = constants$2239.const$2.varHandle(MemoryLayout.PathElement.groupElement("priv"));
    ...
    static final MethodHandle const$5 = RuntimeHelper.upcallHandle(_GtkMenuClass._gtk_reserved1.class, "apply", constants$7.const$5);
}
