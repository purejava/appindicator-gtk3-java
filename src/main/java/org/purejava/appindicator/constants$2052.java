...
final class constants$2052 {
    ...
    static final MethodHandle const$3 = RuntimeHelper.upcallHandle(_AtkPlugClass.get_object_id.class, "apply", constants$5.const$2);
    static final VarHandle const$4 = constants$2052.const$2.varHandle(MemoryLayout.PathElement.groupElement("get_object_id"));
