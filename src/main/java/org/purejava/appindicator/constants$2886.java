...
final class constants$2886 {
    ...
    static final MethodHandle const$1 = RuntimeHelper.upcallHandle(_GtkToolItemClass.create_menu_proxy.class, "apply", constants$10.const$5);
    static final VarHandle const$2 = constants$2886.const$0.varHandle(MemoryLayout.PathElement.groupElement("create_menu_proxy"));
    static final MethodHandle const$3 = RuntimeHelper.upcallHandle(_GtkToolItemClass.toolbar_reconfigured.class, "apply", constants$13.const$1);
    static final VarHandle const$4 = constants$2886.const$0.varHandle(MemoryLayout.PathElement.groupElement("toolbar_reconfigured"));
    static final MethodHandle const$5 = RuntimeHelper.upcallHandle(_GtkToolItemClass._gtk_reserved1.class, "apply", constants$7.const$5);
}
