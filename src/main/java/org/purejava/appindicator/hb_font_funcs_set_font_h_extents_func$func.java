...
/**
 * {@snippet :
 * int (*hb_font_funcs_set_font_h_extents_func$func)(struct hb_font_t*,void*,struct hb_font_extents_t*,void*);
 * }
 */
public interface hb_font_funcs_set_font_h_extents_func$func {
    ...
    static MemorySegment allocate(hb_font_funcs_set_font_h_extents_func$func fi, Arena scope) {
        return RuntimeHelper.upcallStub(constants$1482.const$0, fi, constants$34.const$5, scope);
    }
    static hb_font_funcs_set_font_h_extents_func$func ofAddress(MemorySegment addr, Arena arena) {
