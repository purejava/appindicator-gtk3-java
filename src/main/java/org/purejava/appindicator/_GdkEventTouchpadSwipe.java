...
public class _GdkEventTouchpadSwipe {
    ...
    public static byte phase$get(MemorySegment seg) {
        return (byte)constants$1800.const$2.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static byte phase$get(MemorySegment seg, long index) {
        return (byte)constants$1800.const$2.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static byte n_fingers$get(MemorySegment seg) {
        return (byte)constants$1800.const$3.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static byte n_fingers$get(MemorySegment seg, long index) {
        return (byte)constants$1800.const$3.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static double x$get(MemorySegment seg) {
        return (double)constants$1800.const$5.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static double y$get(MemorySegment seg) {
        return (double)constants$1801.const$0.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void y$set(MemorySegment seg, double x) {
        constants$1801.const$0.set(seg, x);
    }
    public static double y$get(MemorySegment seg, long index) {
        return (double)constants$1801.const$0.get(seg.asSlice(index*sizeof()));
    }
    public static void y$set(MemorySegment seg, long index, double x) {
        constants$1801.const$0.set(seg.asSlice(index*sizeof()), x);
    }
    ...
    public static double dx$get(MemorySegment seg) {
        return (double)constants$1801.const$1.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void dx$set(MemorySegment seg, double x) {
        constants$1801.const$1.set(seg, x);
    }
    public static double dx$get(MemorySegment seg, long index) {
        return (double)constants$1801.const$1.get(seg.asSlice(index*sizeof()));
    }
    public static void dx$set(MemorySegment seg, long index, double x) {
        constants$1801.const$1.set(seg.asSlice(index*sizeof()), x);
    }
    ...
    public static double dy$get(MemorySegment seg) {
        return (double)constants$1801.const$2.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static double dy$get(MemorySegment seg, long index) {
        return (double)constants$1801.const$2.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static double x_root$get(MemorySegment seg) {
        return (double)constants$1801.const$3.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static double x_root$get(MemorySegment seg, long index) {
        return (double)constants$1801.const$3.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static double y_root$get(MemorySegment seg) {
        return (double)constants$1801.const$4.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void y_root$set(MemorySegment seg, double x) {
        constants$1801.const$4.set(seg, x);
    }
    public static double y_root$get(MemorySegment seg, long index) {
        return (double)constants$1801.const$4.get(seg.asSlice(index*sizeof()));
    }
    public static void y_root$set(MemorySegment seg, long index, double x) {
        constants$1801.const$4.set(seg.asSlice(index*sizeof()), x);
    }
