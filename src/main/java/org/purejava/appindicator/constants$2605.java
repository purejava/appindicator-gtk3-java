...
final class constants$2605 {
    ...
    static final VarHandle const$0 = constants$2604.const$5.varHandle(MemoryLayout.PathElement.groupElement("priv"));
    ...
    static final MethodHandle const$2 = RuntimeHelper.upcallHandle(_GtkToggleButtonClass.toggled.class, "apply", constants$13.const$1);
    static final VarHandle const$3 = constants$2605.const$1.varHandle(MemoryLayout.PathElement.groupElement("toggled"));
    static final MethodHandle const$4 = RuntimeHelper.upcallHandle(_GtkToggleButtonClass._gtk_reserved1.class, "apply", constants$7.const$5);
    static final VarHandle const$5 = constants$2605.const$1.varHandle(MemoryLayout.PathElement.groupElement("_gtk_reserved1"));
}
