...
public class _GtkFrameClass {
     ...
     * }
     */
    public final static class compute_child_allocation {

        private compute_child_allocation() {
            // Should not be called directly
        }
    ...
    private static final long compute_child_allocation$OFFSET = $LAYOUT.byteOffset(groupElement("compute_child_allocation"));
