...
public class _GtkFrameClass {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        app_indicator_h.C_POINTER.withName("compute_child_allocation"),
     ...
     * }
     */
    public class compute_child_allocation {
        ...
        private static final MethodHandle UP$MH = app_indicator_h.upcallHandle(compute_child_allocation.Function.class, "apply", $DESC);

        /**
         * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
         * The lifetime of the returned segment is managed by {@code arena}
         */
        public static MemorySegment allocate(compute_child_allocation.Function fi, Arena arena) {
    ...
    private static final AddressLayout compute_child_allocation$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("compute_child_allocation"));
     ...
     * }
     */
    public static final AddressLayout compute_child_allocation$layout() {
        return compute_child_allocation$LAYOUT;
    }

    private static final long compute_child_allocation$OFFSET = 1008;
     ...
     * }
     */
    public static final long compute_child_allocation$offset() {
        return compute_child_allocation$OFFSET;
    }
     ...
     * }
     */
    public static MemorySegment compute_child_allocation(MemorySegment struct) {
        return struct.get(compute_child_allocation$LAYOUT, compute_child_allocation$OFFSET);
    }
     ...
     * }
     */
    public static void compute_child_allocation(MemorySegment struct, MemorySegment fieldValue) {
        struct.set(compute_child_allocation$LAYOUT, compute_child_allocation$OFFSET, fieldValue);
    }
