...
public class _GCancellableClass {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        app_indicator_h.C_POINTER.withName("cancelled"),
    ...
    public class cancelled {
        ...
        private static final MethodHandle UP$MH = app_indicator_h.upcallHandle(cancelled.Function.class, "apply", $DESC);

        /**
         * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
         * The lifetime of the returned segment is managed by {@code arena}
         */
        public static MemorySegment allocate(cancelled.Function fi, Arena arena) {
    ...
    private static final AddressLayout cancelled$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("cancelled"));
     ...
     * }
     */
    public static final AddressLayout cancelled$layout() {
        return cancelled$LAYOUT;
    }

    private static final long cancelled$OFFSET = 136;
     ...
     * }
     */
    public static MemorySegment cancelled(MemorySegment struct) {
     ...
     * }
     */
    public static void cancelled(MemorySegment struct, MemorySegment fieldValue) {
    ...
    private static final long _g_reserved4$OFFSET = 168;
    ...
    private static final long _g_reserved5$OFFSET = 176;
