 ...
 * }
 */
public interface hb_paint_funcs_set_radial_gradient_func$func {
    ...
    static MemorySegment allocate(hb_paint_funcs_set_radial_gradient_func$func fi, Arena scope) {
        return RuntimeHelper.upcallStub(constants$1467.const$2, fi, constants$1448.const$1, scope);
    }
    static hb_paint_funcs_set_radial_gradient_func$func ofAddress(MemorySegment addr, Arena arena) {
