...
public class _GtkOverlayClass {
     ...
     * }
     */
    public final static class get_child_position {

        private get_child_position() {
            // Should not be called directly
        }
    ...
    private static final long get_child_position$OFFSET = $LAYOUT.byteOffset(groupElement("get_child_position"));
