...
final class constants$2471 {
    ...
    static final VarHandle const$0 = constants$2470.const$5.varHandle(MemoryLayout.PathElement.groupElement("priv"));
    static final StructLayout const$1 = MemoryLayout.structLayout(
        ...
        RuntimeHelper.POINTER.withName("row_activated"),
        RuntimeHelper.POINTER.withName("test_expand_row"),
        RuntimeHelper.POINTER.withName("test_collapse_row"),
        RuntimeHelper.POINTER.withName("row_expanded"),
        RuntimeHelper.POINTER.withName("row_collapsed"),
        RuntimeHelper.POINTER.withName("columns_changed"),
        RuntimeHelper.POINTER.withName("cursor_changed"),
        ...
        RuntimeHelper.POINTER.withName("select_cursor_row"),
        RuntimeHelper.POINTER.withName("toggle_cursor_row"),
        RuntimeHelper.POINTER.withName("expand_collapse_cursor_row"),
        RuntimeHelper.POINTER.withName("select_cursor_parent"),
        RuntimeHelper.POINTER.withName("start_interactive_search"),
        RuntimeHelper.POINTER.withName("_gtk_reserved1"),
        RuntimeHelper.POINTER.withName("_gtk_reserved2"),
        RuntimeHelper.POINTER.withName("_gtk_reserved3"),
        RuntimeHelper.POINTER.withName("_gtk_reserved4"),
    ...
    static final MethodHandle const$2 = RuntimeHelper.upcallHandle(_GtkTreeViewClass.row_activated.class, "apply", constants$14.const$3);
    static final VarHandle const$3 = constants$2471.const$1.varHandle(MemoryLayout.PathElement.groupElement("row_activated"));
    static final MethodHandle const$4 = RuntimeHelper.upcallHandle(_GtkTreeViewClass.test_expand_row.class, "apply", constants$12.const$2);
    static final VarHandle const$5 = constants$2471.const$1.varHandle(MemoryLayout.PathElement.groupElement("test_expand_row"));
}
